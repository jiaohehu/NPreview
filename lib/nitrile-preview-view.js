...
console.log('autoScroll is on');
  ...
  updateBlocks() {
    ...
    this.getAllBlocks().then( ([blocks,flags,book]) => {
      ...
      ///this.myfiles = this.parser.parseFILES(this.book);
      ///for (var myfile of this.myfiles) {
        ///let [sublevel,subfname,subpart,subrow] = myfile;
        ///this.registerFileChangeEvent(subfname);
      ///}
