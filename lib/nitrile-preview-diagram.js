...
console.log('james: re_var_command: coords=',coords);
      ...
      if ((v = this.re_halfcircle_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_halfcircle(my_opt,'',coords));
        this.lastcoords = coords;
        continue;
      }
      if ((v = this.re_quadrant_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_quadrant(my_opt,'',coords));
        this.lastcoords = coords;
        continue;
      }
      if ((v = this.re_octant_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_octant(my_opt,'',coords));
        this.lastcoords = coords;
        continue;
      }
      if ((v = this.re_parallelgram_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_parallelgram(rect_opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
          z0 = this.local(z0);
      ...
      if ((v = this.re_rhombus_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_rhombus(my_opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
        }
        continue;
      ...
      if ((v = this.re_trapezoid_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_trapezoid(my_opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
        }
        continue;
      ...
      if ((v = this.re_rect_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_rect(rect_opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
          z0 = this.local(z0);
      ...
      if ((v = this.re_rrect_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_rrect(my_opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
          z0 = this.local(z0);
      ...
      if ((v = this.re_apple_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_apple(my_opt,'',coords));
        this.lastcoords = coords;
      ...
      if ((v = this.re_basket_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_basket(my_opt,'',coords));
        this.lastcoords = coords;
      ...
      if ((v = this.re_crate_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_crate(my_opt,'',coords));
        this.lastcoords = coords;
      ...
      if ((v = this.re_radical_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_radical(my_opt,'',coords));
        this.lastcoords = coords;
        ///var mypath='(3,2)--(0,2)--(0,0)--(3,0)--(3,2)--(0,2)--(1,3)--(4,3)--(3,2)--(3,0)--(4,1)--(4,3)--cycle';
      ...
      if ((v = this.re_brick_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_brick(my_opt,'',coords));
        this.lastcoords = coords;
      ...
      if ((v = this.re_protractor_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_protractor(my_opt,'',coords));
        this.lastcoords = coords;
        var mypath = '(0,0)--(1,0)--(1,0.5)--(0,0.5)--cycle';
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
      ...
      if ((v = this.re_drawarc_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_drawarc(my_opt,'',coords));
