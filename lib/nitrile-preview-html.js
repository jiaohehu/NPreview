...
`;
  ...
  do_verb(block) {
    ...
    for (var k=0; k < text.length; ++k) {
      ...
      line = `<td style='white-space:pre;width:100%;'>${line}</td>`;
      if(this.xnumbers){
        var ln = ++linenum;
    ...
    text = s.join('\n');
    text = `<table border='0' style='line-height:1;border-collapse:collapse;width:100%;border-top:solid 1px;border-bottom:solid 1px;'>${text}</table>`;
