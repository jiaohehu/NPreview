...
class NitrilePreviewDiagramMETAPOST extends NitrilePreviewDiagram {
  ...
  my_shape(align,coords,mypath,w,h) {     
    var s = [];
    var p0 = this.readCoordsLine(null,mypath);
