...
class NitrilePreviewDiagramMP extends NitrilePreviewDiagram {
  ...
  do_finalize(s,style) {
    ...
    if(style && style.width){
      ...
      d.push('\\startMPcode');
      if(num){
        d.push(`numeric textwidth; textwidth := \\the\\textwidth; textwidth := textwidth*${num};`);
      }else{
        d.push(`numeric textwidth; textwidth := ${wd};`)
      }
  ...
  to_linecaps(g) {
    if (g.linecap === 'butt') {
      return 'butt';
    } else if (g.linecap === 'round') {
      return 'rounded';
    } else if (g.linecap === 'square') {
      return 'squared';
    }
    return 'butt';
  }
  ...
  to_linejoins(g) {
    if (g.linejoin === 'miter') {
      return 'mitered';
    } else if (g.linejoin === 'round') {
      return 'rounded';
    } else if (g.linejoin === 'bevel') {
      return 'beveled';
    }
    return 'mitered';
  }
