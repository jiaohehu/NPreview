...
class NitrilePreviewTokenizer {
  ...
  constructor (parser) {
    ...
    this.re_end = /^\\end\{(\w+)\}$/;
    this.re_fontvariants = /^\\(mathit|mathrm|mathscr|mathbf|mathbb|mathcal)\s*\{(.*)\}$/;
  ...
  toDiagramSvg (str) {
    ...
    for (var mathSymbol of pjson.mathSymbols) {
      ...
      if (this.used.has(id)) {
        if(id=='myINT'){
          defs.push(`<text id='${id}' dy='9pt' textLength='${width}pt' lengthAdjust='' style='stroke:none;fill:inherit;font-size:12pt'>${unicode}</text>`);
          continue;
        }
        defs.push(`<text id='${id}' dy='9pt' textLength='${width}pt' lengthAdjust='spacingAndGlyphs' style='stroke:none;fill:inherit;font-size:12pt'>${unicode}</text>`);
      }
    }
    var defs= `\
<defs>
${defs.join('\n')}
    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
        ...
        case '\\nroot':
          ...
          o.push(`</svg>`);
          /// draw overhead line
          o.push(`<line x1='${nlead+lead}pt' y1='0.8pt' x2='${nlead+lead+w}pt' y2='0.8pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
        ...
        case '\\widehat':
          ...
          var x1 = w;
          var y1 = 2.5;
          o.push(`<line x1='${x0}pt' y1='${y0}pt' x2='${xm}pt' y2='${ym}pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<line x1='${x1}pt' y1='${y1}pt' x2='${xm}pt' y2='${ym}pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\overline':
          ...
          o.push(s_);
          o.push(`</svg>`);
          o.push(`<line x1='0pt' y1='1.5pt' x2='${w}pt' y2='1.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\overleftrightarrow':
          ...
          o.push(`</svg>`);
          o.push(`<line x1='0pt' y1='1.5pt' x2='${w}pt' y2='1.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<line x1='0pt'    y1='1.5pt' x2='3pt'      y2='3pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<line x1='0pt'    y1='1.5pt' x2='3pt'      y2='0pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<line x1='${w}pt' y1='1.5pt' x2='${w-3}pt' y2='3pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<line x1='${w}pt' y1='1.5pt' x2='${w-3}pt' y2='0pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\dot':
          ...
          o.push(s_);
          o.push(`</svg>`);
          o.push(`<circle cx='${w/2}pt' cy='${y}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\ddot':
          ...
          o.push(`<circle cx='${x0}pt' cy='${y0}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<circle cx='${x1}pt' cy='${y1}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\dddot':
          ...
          var y1 = this.lower(1.5,id_);
          o.push(`<circle cx='${x0}pt' cy='${y0}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<circle cx='${xm}pt' cy='${ym}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<circle cx='${x1}pt' cy='${y1}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\ddddot':
          ...
          o.push(`<circle cx='${x0}pt' cy='${y0}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<circle cx='${xm}pt' cy='${ym}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<circle cx='${xn}pt' cy='${yn}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<circle cx='${x1}pt' cy='${y1}pt' r='0.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\bar':
          ...
          var x1 = w/2 + 2.5
          var y1 = this.lower(1.5,id_);
          o.push(`<line x1='${x0}pt'  y1='${y0}pt'  x2='${x1}pt'     y2='${y1}pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\vec':
          ...
          var y1 = this.lower(1.5,id_);
          o.push(`<line x1='${x0}pt'  y1='${y0}pt'  x2='${x1}pt'     y2='${y1}pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<line x1='${x1}pt'  y1='${y1}pt'  x2='${x1-1.5}pt' y2='${y1-1.5}pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          o.push(`<line x1='${x1}pt'  y1='${y1}pt'  x2='${x1-1.5}pt' y2='${y1+1.5}pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\mathring':
          ...
          var x1 = w/2 + 1.5
          var y1 = this.lower(1.5,id_);
          o.push(`<circle cx='${xm}pt' cy='${ym}pt' r='1.5pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\breve':
          ...
          x1 *= 1.33;
          y1 *= 1.33;
          o.push(`<svg x='-0.5pt' y='${dy}pt'><path d='M ${x0},${y0} a1,1 0 0,0 ${x1-x0} 0' style='stroke:inherit; fill:none; font-size:12pt;'/></svg>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\tilde':
          ...
          x1 *= 1.33;
          y1 *= 1.33;
          o.push(`<path d='M ${x0},${y0} Q ${(x0+xm)/2},${zh} ${xm},${ym} Q ${(xm+x1)/2},${zl*1.33} ${x1},${y1}' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\od':
          ...
          o.push(`<line x1='0pt' y1='${hline_dy}pt' x2='${w}pt' y2='${hline_dy}pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
          this.fraclevel -= 1;
          mid = hline_dy;
          h = dy;
        ...
        case '\\sqrt':
          ...
          if(1){
            ...
            //o.push(`</svg>`);
            o.push(`<line x1='${lead}pt' y1='0.8pt' x2='${w}pt' y2='0.8pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
            this.used.add('mySQRT');
            if(n){
        ...
        case '\\frac':
          ...
          if (w1_ < w2_) {
            ...
            o.push(s2_);
            o.push(`</svg>`);
            o.push(`<line x1='0pt' y1='${1.5+h1_}pt' x2='${w}pt' y2='${1.5+h1_}pt' style='stroke:inherit; fill:none; font-size:12pt;'/>`);
            var newv = [w,h,mid,o.join('\n'),0,0,''];
          } else {
            var dx = 1+ (w1_ - w2_)/2;
        ...
        case '\\sup':
          ...
          var q = 0;
          if (v[1] === '\\lim' || v[1] === '\\int' || v[1] === '\\sum' || v[1] === '\\prod') {
            var q = 1;
          ...
          if (!this.isinmatrix && this.isdisplaymath && (
            ...
            var o = [];
            if (1) {
              var sy = nh1_/12;///as a ratio to 12pt, thus if it is 13pt height then the ratio is 13/12
        ...
        if (pjson.fontVariants[key]) {
          for (var c of str) {
            ...
            if (val) {
              ...
              let opts = [];
              opts.push(`style='stroke:none; fill:inherit; font-size:12pt;'`); 
              opts.push(`x='${x}pt'`);
              opts.push(`dx='${dx}'`);
              opts.push(`dy='0.75em'`);
      ...
      if (id === 'myINT') { /// THIS is \\int symbol by itself, 
        var w = width;  
        var h = 12;
        var mid = 6;
        ...
        if(1){
          var o = [];
          var sy = h/12;///as a ratio to 12pt, thus if it is 13pt height then the ratio is 13/12
  ...
  to_text_element(text,keepwhitespace){
    ...
    var x0;
    for (var x of xx) {
      if (this.re_space.test(x)) {
        if(keepwhitespace && x.localeCompare(x0)!==0){
          totalw += 4;///asssume 4pt width for a non-breakable space
          newtext += '&#160;'
        }
        x0 = x;
        continue;
      }
      var [id, width, op] = this.findIdByElement(x);
      totalw += width;
      newtext += x;
    ...
    /// display it as text.
    var s = `<text x='0' y='0' dy='0.75em' textLength='${totalw}pt' lengthAdjust='spacingAndGlyphs' style='stroke:none;fill:inherit;font-size:12pt'>${newtext}</text>`
    var w = totalw;
    var h = 12.0;
    var mid = 6.0;
  ...
  toSvg (v) {
    ...
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:12pt;' id='myA'>&#x1D44E;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:12pt;' id='myB'>&#x1D44F;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:12pt;' id='myC'>&#x1D450;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:12pt;' id='myD'>&#x1D451;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:12pt;' id='myN'>&#x1D45B;</text>
    ///<text dy='1em' style='stroke:none; fill:inherit; font-size:12pt;' id='mySQRT'>&#x221A;</text>
    ///<text dy='1em' style='stroke:none; fill:inherit; font-size:12pt;' id='myOVERLINE'>&#x0305;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:12pt;' id='myPLUS'>+</text>
    ///
    ...
    for (var mathSymbol of pjson.mathSymbols) {
      ...
      if (this.used.has(id)) {
        ...
        defs.push(`<text dy='${dy}' dx='${dx}' id='${id}' textLength='${width}pt' lengthAdjust='spacingAndGlyphs' style='stroke:none; fill:inherit; font-size:12pt;'>${unicode}</text>`);
      }
    }
    var s = `\
<svg 
