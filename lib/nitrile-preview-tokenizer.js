...
class NitrilePreviewTokenizer {
  ...
  async svgize (str,isdisplaymath = false) {
    return this.parse(str,isdisplaymath);
  } 
      ...
      switch (v[0]) {
        ...
        case '\\sup':  
          ...
          if (this.isdisplaymath && v[1] === '\\sum') {
            var o = [];
            var nw1_ = w1_*this.display_rate;
            var nh1_ = h1_*this.display_rate;
            var nmid1_ = mid1_*this.display_rate;
            ...
            o.push(`<svg x='0' y='${h}pt' width='${nw1_}pt' height='${nh1_}pt' viewbox='0 0 ${w1_*1.333} ${h1_*1.333}'>`);
            o.push(s1_);
            o.push(`</svg>`);
            h += nh1_;
          ...
          } else if (this.isdisplaymath && v[1] === '\\lim') {
