...
`;
  ...
  do_imgs(block) {
    ...
    images.forEach(x => {
        ...
        s.push(`<span style='display:inline-block;text-align:center;'><img id='nitrileimg-${imgid}' src='${imgsrc}' style='vertical-align:text-bottom;width:100%;' alt='${src}'/><small>${sub}</small></span>`);
    });
    s.push('</p>');
