      ...
      switch (sig) {
          ...
          if (fig) {
            ...
            for (var k=0; k < text.length; k += increment) {
              if (k == 0) {
                ...
                o.push(`\\begin{lstlisting}[float=*,basicstyle=\\ttfamily,breaklines=true,postbreak=\\textrightarrow\\space,firstnumber=${k+1},${numbers_text} ]`);
              }
        ...
        case 'VERB': {
          ...
          if (fig) {
            ...
            o.push(`\\begin{lstlisting}[basicstyle=\\ttfamily\\footnotesize,breaklines=true,postbreak=\\textrightarrow\\space,xleftmargin=${left},columns=fullflexible,escapeinside=||,breakindent=6pt,frame=single]`)
            for (var line of text) {
              o.push(line);
            }
            o.push('\\end{lstlisting}')
            ...
            o.push(`\\begin{lstlisting}[basicstyle=\\ttfamily\\footnotesize,breaklines=true,postbreak=\\textrightarrow\\space,xleftmargin=${left},columns=fullflexible,escapeinside=||,breakindent=6pt]`)
            for (var line of text) {
              o.push(line);
            }
            o.push('\\end{lstlisting}')
