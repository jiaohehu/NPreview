        ...
        case 'FIGE': {
          ...
          for (var pp of text) {
            var kk = pp.map( x => {
                ...
                return `<img id='${imgid}' alt='${src}' src='${imgdata}' width='${100.0*width}%' style='vertical-align:text-bottom; min-width:${100.0*width}%; min-height:100px; outline:1px solid #333;' />`;
            });
            o.push(`<nobr>`);
            o.push(kk.join(''));
            o.push(`</nobr>`);
