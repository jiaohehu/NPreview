...
class NitrilePreviewContext extends NitrilePreviewTranslator {
  ...
  do_long(block){
    ...
    let vlines = this.toArray(this.xconfig.longvlines);
    let hlines = this.toArray(this.xconfig.longhlines);
...
\\setuppapersize[${this.xconfig.papersize}]
\\setuppagenumbering[location={header,right},style=]
\\setuplayout
 [width=${this.xconfig.width}mm,
