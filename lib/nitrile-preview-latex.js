    ...
    for (var block of all) {
      ...
      switch (sig) {
        ...
        case 'tabular': {
          ...
          o.push(this.toSingleLineRows(hlines,fencecmd.booktab,rows));
        ...
        case 'tabulary': {
          ...
          o.push(this.toParagraphRows(hlines,fencecmd.booktab,rows));
          if(hlines.indexOf('b')>=0){
            if(fencecmd.booktab){
              o.push('\\bottomrule');
            }else{
...
///console.log(o);
  ...
  toParagraphRows(hlines,booktab,rows) {
    var o = [];
    if (rows.length == 0) {
      o.push('(empty) ');
    } else {
  ...
  toSingleLineRows(hlines,booktab,rows) {
    var o = [];
    if (rows.length == 0) {
      o.push('(empty) ');
    } else {
