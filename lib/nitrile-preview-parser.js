...
///console.log(config);
  ...
  isSkipping (config, dept) {
    if (config.previewOutlineEnabled && !this.isSectionShowing(dept,config.previewOutlineSections)) {
      return true;
    } else {
      return false;
    }
  ...
  isSkippingHdgs (config, dept, cat) {
    if (!config.previewOutlineEnabled) {
      return false;
    }
    if (this.isSectionShowing(dept,config.previewOutlineSections)) {
      return false;
    }
