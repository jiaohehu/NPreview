...
class SphinxPreviewParser {
  ...
  toBLOCKS(lines) {
    ...
    while (lines.length > 0) {
      ...
      if (para[0] === '% !BOOK') {
        ...
        o.push([nblocks,row,row2,'BOOK',0,data,para]);
        continue;
      }
      ...
      if (nblocks == 1) {
        ...
        var data = [0,text];
        o.push([nblocks,row,row2,'HDGS',0,data,para]);
        continue;
      }
      ...
      if (the_fence === '---') {
        ...
        o.push([nblocks,row,row2,'VRSE',n,data,para]);
        continue
      }
      ...
      if (the_fence === '~~~') {
        var [data, n] = this.trimPara(para);
        var data = this.trimFences(data);
        o.push([nblocks,row,row2,'CODE',n,data,para]);
        continue;
      }
      ...
      if (the_fence === '///') {
        ...
        o.push([nblocks,row,row2,'PICT',n,data,para]);
        continue;
      }
      ...
      if (the_fence === '===') {
        ...
        o.push([nblocks,row,row2,'TABB',n,data,para]);
        continue;
      }
      ...
      if (the_fence === '<<<') {
        ...
        o.push([nblocks,row,row2,'TERM',n,data,para]);
        continue;
      }
      ...
      if (the_fence === '\"\"\"') {
        ...
        o.push([nblocks,row,row2,'QUOT',n,data,para]);
        continue;
      }
      ...
      if (re.test(para[0])) {
        ...
        o.push([nblocks,row,row2,'DEF1',n,data,para]);
        continue;
      }
      ...
      if (re.test(para[0])) {
        var data = this.parseDEF(para,re);
        o.push([nblocks,row,row2,'DEF2',n,data,para]);
        continue;
      }
      ...
      if (re.test(para[0])) {
        var data = this.parseDEF(para,re);
        o.push([nblocks,row,row2,'DEF3',n,data,para]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        o.push([nblocks,row,row2,'PRIM',0,data,para]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        o.push([nblocks,row,row2,'SECO',0,data,para]);
        continue;
      }
      ...
      if (v) {
        ...
        o.push([nblocks,row,row2,'PLST',n,data,para]);
        continue
      }
      ...
      if (true) {
        var [data, n] = this.trimPara(para);
        var data = this.joinPara(data);
        o.push([nblocks,row,row2,'',n,data,para]);
        continue;
      }
  ...
  */
  parsePICT (para) {
    ...
    for (var line of para) {
      if (line.startsWith(': ')) {
        caption = this.joinLine(caption,line.slice(2));
        continue;
      }
