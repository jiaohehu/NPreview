...
///console.log(`image ${fsrc} changed`);
  ...
  refreshView() {
    ...
    ///STOP calling it. Because parser.idenBlocks() has assigned idnum
...
`;
        ...
        data = await epub.generateAsync(this.parser,this.parser.escape(this.title),this.parser.escape(this.author),htmls,chaps,this.imagemap,!this.isReport,this.dirname());
