...
class NitrilePreviewDiagramMP {
  ...
  initSettings() {
    ...
    this.def_tickwidth = this.tickwidth = 1;
  ...
  toMetaPost(para) {
    ...
    for (row in para) {
      ...
      if ((v = this.re_octant_command.exec(line)) !== null) {
        ...
        for (var i = 0; this.valid(coords, i); i++) {
          ...
          if (circle_opt === '.o1' ||
            ...
            if (this.fillcolor) {
              o.push(`fill (octantcircle--(0,0)--cycle) rotated(${rot}) scaled(${this.diameter}) shifted(${x},${y}) scaled(u) ${this.fills()};`);
            }
            if (this.linewidth !== '0') {
              o.push(`draw (octantcircle--(0,0)--cycle) rotated(${rot}) scaled(${this.diameter}) shifted(${x},${y}) scaled(u) ${this.draws()};`);
            }
          } 
        }
        continue;
      ...
      if ((v = this.re_rhombus_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        var mypath = `(0,0.5)--(0.5,1)--(1,0.5)--(0.5,0)--(0,0.5)--cycle`;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(o, coords, i);
          z0 = this.local(z0);
          var x = z0[0];
          var y = z0[1];
          if (this.fillcolor) {
            o.push(`fill (${mypath}) xscaled(${this.rectw}) yscaled(${this.recth}) shifted(${x},${y}) scaled(u) ${this.fills()};`);
          }
          if (this.linewidth !== '0') {
            o.push(`draw (${mypath}) xscaled(${this.rectw}) yscaled(${this.recth}) shifted(${x},${y}) scaled(u) ${this.draws()};`);
          }
        }
        continue;
      }
      if ((v = this.re_trapezoid_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        var mypath = `(0,0)--(1,0)--(0.6,1)--(0.2,1)--(0,0)--cycle`;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(o, coords, i);
          z0 = this.local(z0);
          var x = z0[0];
      ...
      if ((v = this.re_rrect_command.exec(line)) !== null) {
        ...
        for (var i = 0; this.valid(coords, i); i++) {
          ...
          var y = z0[1];
          if (this.fillcolor) {
            o.push(`fill runitsquare xscaled(${this.rectw}) yscaled(${this.recth}) shifted(${x},${y}) scaled(u) ${this.fills()};`);
          }
          if (this.linewidth !== '0') {
            o.push(`draw runitsquare xscaled(${this.rectw}) yscaled(${this.recth}) shifted(${x},${y}) scaled(u) ${this.draws()};`);
          }
        }
        continue;
      }
      if ((v = this.re_dot_command.exec(line)) !== null) {
        ...
        for (var i = 0; this.valid(coords, i); i++) {
          ...
          if (dot_opt === '') {
            ...
            var withpen = `withpen pencircle scaled ${this.dotsize*0.75}pt`;
      ...
      if ((v = this.re_drawarc_command.exec(line)) !== null) {
        ...
        for (var i = 1; this.valid(coords, i - 1) && this.valid(coords, i); ++i) {
          var z0 = this.point(o, coords, i - 1);
          var z1 = this.point(o, coords, i);
          z0 = this.local(z0);
          z1 = this.local(z1);
          var X1 = z0[0];
          var Y1 = z0[1];
    ...
    o.unshift('path runitsquare; runitsquare := (0,0.2){down}..(0.058,0.058)..{right}(0.2,0)--(0.8,0){right}..(0.958,0.058)..{up}(1,0.2)--(1,0.8){up}..(0.958,0.958)..{left}(0.8,1)--(0.2,1){left}..(0.058,0.958)..{down}(0,0.8)--cycle ;');
