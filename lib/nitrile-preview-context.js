...
class NitrilePreviewContext extends NitrilePreviewParser {
  ...
  do_diag(block){
    ...
    if (fencecmd.star) {
      ...
      var unit = mp.unit;
      o.push('\\startMPcode');
      o.push('color darkred; darkred := (.625,0.0);');
      o.push(`textwidth := 13cm;`);
      o.push(`pu := textwidth/32;`);
      o.push(`u := 4mm;`);
      o.push(`ratio := pu/u;`);
...
\\definecolor[darkgray][r=.66,g=.66,b=.66] % a RGB color
\\definecolor[lightgray][r=.83,g=.83,b=.83] % a RGB color
\\definecolor[brown][r=.627,b=.32,b=.17] % a RGB color
\\definecolor[lime][r=0,g=.5,b=0] % a RGB color
\\definecolor[olive][r=.5,g=.5,b=0] % a RGB color
\\definecolor[orange][r=1,g=.65,b=0] % a RGB color
\\definecolor[pink][r=1,g=.75,b=.79] % a RGB color
\\definecolor[teal][r=0,g=.5,b=.5] % a RGB color
\\definecolor[purple][r=.5,g=0,b=0] % a RGB color
