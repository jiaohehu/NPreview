...
`
  ...
  translateHtml (config,xrefs,blocks,isarticle,o) {
    ...
    for (var block of blocks) {
      ...
      const showidtext    = config.showids    ? `<mark style='font-size:small; position:absolute; '>[${id}]</mark>` : '';
      switch (sig) {
        case 'FILE': {
        ...
        case 'HDGS': {
          ...
          switch (cat) {
            case 0:
              ...
              o.push(`Chapter ${dept} &#160; ${this.escape(text)} ${showlabeltext} ${showidtext} `);
              o.push(`</h1>`);
              break;
            case 1:
              heading = 'SECTION';
              o.push(`<h2 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='${this.sectioncssstyle}'>`);
              o.push(`${dept} &#160; ${this.escape(text)} ${showlabeltext} ${showidtext} `);
              o.push(`</h2>`);
              break;
            case 2:
              heading = 'SUBSECTION';
        ...
        case 'CODE':  
          ...
          if (fig) {
            ...
            o.push(`<span> Listing ${fig} : ${this.unmask(caption)} ${showlabeltext} ${showidtext} </span>`);
            o.push(text);
            o.push(`</div>`);
            o.push('');
        ...
        case 'PICT':  
          ...
          if (fig) {
            var text = data;
            o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='margin:1em 0; column-span:all;'>`);
            o.push(` <span style='text-align:center' > Figure ${fig}: ${this.unmask(caption)} ${showlabeltext} ${showidtext} <span>`);
        ...
        case 'TABB': {
          ...
          if (fig) {
            ...
            o.push(` <span> Table ${fig}: ${this.unmask(caption)} ${showlabeltext} ${showidtext} <span>`);
            o.push(text);
            o.push('</div>');
            o.push('');
          } else {
