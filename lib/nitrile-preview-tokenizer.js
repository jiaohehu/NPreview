...
class NitrilePreviewTokenizer {
  ...
  parse (str, isdisplaymath = false, addoutline = false) {
    ...
    var g = this.toCommands(g);
    var g = this.toSubsup(g);
    var {s,nw,nh,shiftdist} = this.toSvg(g, addoutline);
    return s;
  }

  toMathSvg (str, isdisplaymath = false, addoutline = false) {
    str = str.trim();
    if(!str){ 
      var s = '';
      var nw = 0;
    ...
    var g = this.toCommands(g);
    var g = this.toSubsup(g);
    return this.toSvg(g, addoutline);
  }
...
//console.log('s_=',s_);
        ...
        case '\\sqrt':
          ...
          if(n==2){
            ...
            o.push(`<svg x='0' y='0' width='${lead}pt' height='${h}pt' viewBox='0 0 10.666 16' preserveAspectRatio='none'>`);
            o.push(`<use x='0' y='0' xlink:href='#myCBRT' />`);
            o.push(`</svg>`);
            o.push(`<line x1='${lead}pt' y1='0.8pt' x2='${w}pt' y2='0.8pt' class='MyLine'/>`);
            this.used.add('myCBRT');
          } else if(n==4){
            o.push(`<svg x='0' y='0' width='${lead}pt' height='${h}pt' viewBox='0 0 10.666 16' preserveAspectRatio='none'>`);
            o.push(`<use x='0' y='0' xlink:href='#myQDRT' />`);
            o.push(`</svg>`);
            o.push(`<line x1='${lead}pt' y1='0.8pt' x2='${w}pt' y2='0.8pt' class='MyLine'/>`);
            this.used.add('myQDRT');
          } else {
            o.push(`<svg x='0' y='0' width='${lead}pt' height='${h}pt' viewBox='0 0 10.666 16' preserveAspectRatio='none'>`);
            o.push(`<use x='0' y='0' xlink:href='#mySQRT' />`);
            o.push(`</svg>`);
        ...
        if (pjson.fontVariants[key]) {
          for (var c of str) {
            ...
            if (val) {
              ...
              o.push( `<text class='MyText' x='${x}pt' dx='${dx}' dy='0.75em'>${unicode}</text>` );
              x += width;
              w += width;
            }
          }
