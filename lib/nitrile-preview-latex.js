...
class NitrilePreviewLatex extends NitrilePreviewParser {
  ...
  do_verb(block){
    ...
    if (this.xnumbers) {
      ...
      s.push(`\\begin{xtabular}{@{}l@{\\hskip ${this.xnumbersep}}l}`);
      var linenum = 0;
      for (var k=0; k < text.length; ++k) {
        ...
        s.push(`{\\scriptsize{}${++linenum}} & {\\ttfamily${this.xlatexfontsize}{}${line}}\\\\`);
        while (lines.length > 0) {
          var line = lines.shift();
          line = this.escapeSolid(line);
          s.push(`& {\\ttfamily${this.xlatexfontsize}{}${line}}\\\\`);
        }
      }
      s.push('\\end{xtabular}');
...
\\end{document}\n`;
  ...
  toListing(o,id,sig,fname,row1,row2,data,fencecmd) {
    ...
    if (this.xnumbers) {
      myopts.push(`fontsize=${this.xlatexfontsize}`);
    ...
    o.push(`\\begin{flushleft}`);
    o.push(`\\begin{xtabular}{@{}l@{\\hskip ${this.xnumbersep}}l}`);
    var linenum = 0;
    for (var k=0; k < text.length; ++k) {
      var line = text[k];
      var lines = [line];
      ...
      var line = lines.shift();
      line = this.escapeSolid(line);
      o.push(`{\\scriptsize{}${++linenum}} & {\\ttfamily${this.xlatexfontsize}{}${line}}\\\\`);
      while (lines.length > 0) {
        var line = lines.shift();
        line = this.escapeSolid(line);
        o.push(`& {\\ttfamily${this.xlatexfontsize}{}${line}}\\\\`);
      }
    }
    o.push('\\end{xtabular}');
    o.push(`\\end{flushleft}`);
