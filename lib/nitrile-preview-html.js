...
`
  ...
  toFramedSvg (para ) {
    ...
    o.push( `<text style='font-family:monospace;white-space:pre;font-size:${fontsize}px;' text-anchor='start' x='0' y='0' textLength='${vw}px' lengthAdjust='spacing' >` );
    for (var i=0; i < npara; ++i) {
      ...
      var x = 0;
      o.push( `<tspan y='${(i+1)*10*1.333333}px' x='0'>${s}</tspan>` );
    }
    o.push( `</text>`);
    o.push( "</svg>" );
    return [o.join('\n'), vw, vh];
