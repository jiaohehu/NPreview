    ...
    for (var block of blocks) {
      ...
      switch (sig) {
        ...
        case 'SMPL': {
          ...
          text = text.map( x => `<dt><code style='${this.codecssstyle}' >${x}</code></dt>` );
          o.push(text.join('\n'));
          o.push(`</dl>`);
          o.push(`</div>`);
          o.push('');
        ...
        case 'PRGM': {
          ...
          text = text.map( x => this.escape(x) );
          text = text.join('\n');
          o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='margin-left:0; column-span:all;'>`);
          o.push(`<pre style='${this.precssstyle}' >${text}</pre>`);
          o.push(`</div>`);
          o.push('');
          break;
        ...
        case 'TABB': {
          ...
          var text = data;
          o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
          o.push(`<table style='${this.paracssstyle}' >`);                
        ...
        case 'TERM': {
          ...
          if (fencecmd.table) {
            var text = data;
            o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
            o.push(`<table width='100%' style='${this.paracssstyle}' >`);         
            o.push(`<colgroup>`);
            o.push(`<col width='30%'/>`);
            o.push(`<col width='70%'/>`);
            o.push(`</colgroup>`);
            ...
            for(var i=0; i < text.length; i+=2) {
              ...
              o.push(`<dt><code style='${this.codecssstyle}' >${dt}</code></dt>`);
        ...
        case 'DESC': {
          ...
          for (i=0; i < keys.length; ++i) {
            if (cat === 'mono') {
              o.push(`<dt><code style='${this.codecssstyle}' ><b>${this.escape(keys[i])}</b></code></dt>`);
            } else if (cat === 'strong') {
