    ...
    for (line of para) {
      ...
      if ((v = this.re_label_command.exec(line)) !== null) {
        ...
        for (var i=0; i < coords.length; ++i) {
          var z0 = this.point(o, coords,i); if(this.iscycle(z0)) { break; }
      ...
      if ((v = this.re_circle_command.exec(line)) !== null) {
        ...
        var coords = this.readCoordsLine(o, line);
        for (var i=0; i < coords.length; i++) {
          z0 = this.point(o, coords,i); if(this.iscycle(z0)) { break; }
          z0 = this.local(z0);
          var x = z0[0];
          var y = z0[1];
          if (circle_opt==='') {
      ...
      if ((v = this.re_drawarc_command.exec(line)) !== null) {
        ...
        for (var i=1; i < coords.length; ++i) {
          var z0 = this.point(o, coords,i-1); if (this.iscycle(z0)) { break; }
          var z1 = this.point(o, coords,i); if (this.iscycle(z1)) { break; }
          z0 = this.local(z0);
          z1 = this.local(z1);
          var X1 = z0[0];
          var Y1 = z0[1];
