...
//console.log('nh1_=',nh1_);
//console.log('nmid1_=',nmid1_);
      ...
      if (id === 'myINT') { /// THIS is \\int symbol by itself, 
        ...
        /// If it starts with a backslash, suchas \Rot, 
        /// treat it as a math function
        var s = `<text class='MyText' x='0' y='0' dy='0.75em' textLength='${totalw}pt' lengthAdjust='spacingAndGlyphs'>${v}</text>`
        var w = totalw;
        var h = 12.0;
        var mid = 6.0;
        return [w,h,mid,s,0,1,''];
