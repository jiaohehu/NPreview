...
//console.log(data);
        ...
        case 'diagram': {
          ...
          o.push(`${showidtext}`);
          o.push(`<p style='${this.paracssstyle}; text-align:left; margin:0; line-height:1; font-size:small;' >`);
          o.push(`<svg xmlns:xlink='http://www.w3.org/1999/xlink' width='100%' height='auto' viewBox='0 0 ${vw} ${vh}'\
                  style='box-sizing:border-box; border:1px solid orange;' role='img' focusable='false' xmlns='http://www.w3.org/2000/svg' >`);
          o.push(text);
          o.push(`</svg>`);
          o.push(`</p>`);
          o.push('</div>');
