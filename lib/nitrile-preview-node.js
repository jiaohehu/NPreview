...
.nitrile-preview .PAGE {
  box-sizing: border-box;
  width: 8.5in;
  padding: 1.25in 1.75in 1.25in 1.75in;
  margin: 0;
  font-size: 12pt;
...
console.log(xrefs);
    ...
    var documentclassopts = config.documentclassopts;
    var data = `% !TEX program = ${config.texfamily}
\\documentclass[${documentclassopts.join(',')}]{${documentclass}}
...
<div class='PAGE' style='width:21.6cm;padding-left:${config.leftmargin}cm; padding-right:${config.rightmargin}cm; '>
<p class='TITLE'>
${parser.escape(title)}
</p>
<p class='AUTHOR'>
