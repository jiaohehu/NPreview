...
class NitrilePreviewHtml extends NitrilePreviewParser {
  ...
  /*
    ...
    */
  translateHtml (config,blocks,isarticle,hiddendepts,o) {
        ...
        case 'HDGS': {
          ...
          switch (cat) {
            case 0:
              ...
              if (hiddendepts.hasOwnProperty(dept)) o.push(`<small>(hidden)</small>`);
              o.push(`</h1>`);
              break;
            case 1:
              heading = 'SECTION';
  ...
  */
  style (type, text) {
    ...
    switch (type) {
      ...
      case 'ref': {
        return `<small>\[<a href='#${text}'>${this.escape(text)}</a>\]</small>`
        break;
      }
      default: {
