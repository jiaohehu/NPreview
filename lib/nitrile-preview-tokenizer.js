...
const re_token = /\\\;|\\\,|\\\:|\\\\|\\\{|\\\}|\\sqrt\[.*?\]|\\begin\{\w+\}|\\end\{\w+\}|(\\mathscr|\\mathcal|\\mathbb|\\mathrm|\\mathit)\s*\{[A-Za-z0-9]*\}|\\[a-zA-Z]+|./g;
...
const re_fontvariants = /^\\(mathit|mathrm|mathscr|mathbb|mathcal)\s*\{(.*)\}$/;
...
<defs> <style type="text/css"><![CDATA[
     .MyText { drawline: none; fill: black; font-size: 12pt; }
     .MyLine { drawline: black; fill: none; font-size: 12pt; }
  ]]></style>
  ${defs.join('\n')}
</defs>
${news}
