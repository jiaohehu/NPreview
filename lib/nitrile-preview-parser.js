...
class NitrilePreviewParser {
    ...
    */
    ...
    while (lines.length > 0) {
      ...
      if (flags.verbatim && this.re_four_spaces.test(para[0])) {
        ...
        var fencecmd = {};
        o.push([id,row,row2,'VERB',0,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '```') {
        ...
        o.push([id,row,row2,'CODE',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '~~~') {
        ...
        var [data,fence,fencecmd] = this.trimFences(data);
        id = this.toSid(id,fencecmd.label);
        o.push([id,row,row2,'VERB',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '---') {
        ...
        var [data,fence,fencecmd] = this.trimFences(data);
        id = this.toSid(id,fencecmd.label);
        o.push([id,row,row2,'VRSE',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue
      }
      ...
      if (the_fence === '///') {
        ...
        id = this.toSid(id,fencecmd.label);
        o.push([id,row,row2,'PICT',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '===') {
        ...
        id = this.toSid(id,fencecmd.label);
        o.push([id,row,row2,'TABB',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '<<<') {
        ...
        id = this.toSid(id,fencecmd.label);
        o.push([id,row,row2,'TERM',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '\"\"\"') {
        ...
        id = this.toSid(id,fencecmd.label);
        o.push([id,row,row2,'QUOT',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '@@@') {
        ...
        id = this.toSid(id,fencecmd.label);
        o.push([id,row,row2,'SPEC',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (this.re_hyphen_hyphen.test(para[0])) {
        ...
        var fencecmd = {};
        o.push([id,row,row2,'DESC',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        var fencecmd = {};
        o.push([id,row,row2,'PRIM',0,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        var fencecmd = {};
        o.push([id,row,row2,'SECO',0,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var fencecmd = {};
        o.push([id,row,row2,'PLST',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue
      }
      ...
      if ((v = this.re_hdgs.exec(para[0])) !== null) {
        ...
        var fencecmd = {};
        o.push([sid,row,row2,'HDGS',0,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (nblocks == 1) {
        ...
        var fencecmd = {};
        o.push([id,row,row2,'HDGS',0,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
      ...
      if (true) {
        ...
        var data = this.joinPara(data);
        var fencecmd = {};
        o.push([id,row,row2,'',n,data,para,fencecmd,dept,caption,hidden,fname,plevel]);
        continue;
      }
  ...
  async toBookBlocks(lines,dirname) {
    ...
    var myOpeners = myFiles.map( myfile => {
      var [sublevel,subfname] = myfile;
      var fsubfname = path.join(dirname,subfname);
      var subprom = this.readFileAsync(fsubfname);
      return [sublevel,subfname,fsubfname,subprom];
    });
    for (var myOpener of myOpeners) {
      let [sublevel,subfname,fsubfname,subprom] = myOpener;
      try {
  ...
  newFILE (fname,plevel) {
    ...
    return [id,-1,-1,'FILE',0,[],[],fencecmd,dept,caption,hidden,fname,plevel];
  ...
  newFEND (fname,plevel) {
    ...
    var caption = '';
    var id = `${this.toBase(fname)}::`;
    return [id,-1,-1,'FEND',0,[],[],fencecmd,dept,caption,hidden,fname,plevel];
  ...
  newHDGS (str,fname,plevel) {
    ...
    var dept = '';
    var caption = '';
    return ['',-1,-1,'HDGS',0,[0,str],[],fencecmd,dept,caption,hidden,fname,plevel];
  ...
  idenBlocks (blocks,isarticle) {
    ...
    for (var block of blocks) {
      const [id,row1,row2,type,n,data,para,fencecmd,dept,caption,hidden,fname,plevel] = block;
      var sec_text = '';
      switch (type) {
        case 'HDGS': {
