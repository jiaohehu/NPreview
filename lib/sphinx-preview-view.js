...
const latexparser  = require('./sphinx-preview-latex');
const htmlparser   = require('./sphinx-preview-html');
const fs = require('fs');
...
export default class SphinxPreviewView {
  ...
  registerAllCommands () {
    this.disposables.add(
      ...
      atom.commands.add(this.element, {
        ...
        'sphinx-preview:tolualatexarticle': () => {
          this.tolualatexarticle();
        },
        'sphinx-preview:tolualatexchapter': () => {
          this.tolualatexchapter();
        },
        'sphinx-preview:tolualatexbook': () => {
          this.tolualatexbook();
        },
        'sphinx-preview:toxhtml': () => {
          this.toxhtml();
        },
        'core:move-up': () => {
  ...
  */
  ...
  update() {
    ...
    var [html, metadata] = htmlparser.toPREVIEW(lines);
...
${this.html}
  ...
  */
  tolualatexarticle () {
    ...
    latexparser.toARTICLE(this.lines)
      .then((out) => {
        atom.workspace.paneForItem(this.editor).activate();
  ...
  */
  tolualatexchapter () {
    ...
    latexparser.toCHAPTER(this.lines)
      .then((out) => {
        atom.workspace.paneForItem(this.editor).activate();
        atom.workspace.open().then((item) => item.setText(out));
      });
  ...
  */
  tolualatexbook () {
    ...
    console.log(dirname);
    latexparser.toBOOK(this.lines,dirname)
      .then((out) => {
        atom.workspace.paneForItem(this.editor).activate();
        atom.workspace.open().then((item) => item.setText(out));
      });
