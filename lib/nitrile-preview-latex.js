      ...
      switch (sig) {
        ...
        case 'CODE':  
          ...
          if (fig) {
            ...
            for (var k=0; k < text.length; k += increment) {
              if (k == 0) {
                o.push(`\\begin{lstlisting}[float=*,basicstyle=\\ttfamily,breaklines=true,postbreak=\\textrightarrow\\space,firstnumber=${k+1},${numbers_text} label=${label},caption={${this.unmask(caption)}}]`);
              } else {
                o.push(`\\begin{lstlisting}[float=*,basicstyle=\\ttfamily,breaklines=true,postbreak=\\textrightarrow\\space,firstnumber=${k+1},xleftmargin=${left},${numbers_text} ]`);
              }
            ...
            var text = data;
            var numbers_text = (fencecmd.n) ? `numbers=left,` : ``;
            o.push(`\\begin{lstlisting}[basicstyle=\\ttfamily,breaklines=true,postbreak=\\textrightarrow\\space,xleftmargin=${left},${numbers_text} ]`);
        ...
        case 'VERB': {
          ...
          if (fig) {
            ...
            o.push(`\\begin{lstlisting}[basicstyle=\\ttfamily\\footnotesize,breaklines=true,postbreak=\\textrightarrow\\space,xleftmargin=${left},columns=fullflexible,breakindent=6pt,frame=single]`)
            for (var line of text) {
              o.push(line);
            }
            o.push('\\end{lstlisting}')
            ...
            o.push(`\\begin{lstlisting}[basicstyle=\\ttfamily\\footnotesize,breaklines=true,postbreak=\\textrightarrow\\space,xleftmargin=${left},columns=fullflexible,breakindent=6pt]`)
            for (var line of text) {
              o.push(line);
            }
            o.push('\\end{lstlisting}')
