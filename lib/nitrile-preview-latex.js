...
class NitrilePreviewLatex extends NitrilePreviewParser {
  ...
  translateLatex (autonum,config,xrefs,blocks,isarticle,subrow,plevel,o) {
      ...
      switch (sig) {
        ...
        case 'SMPL': {
          ...
          if (config.samplestyle === 'blockquote') {
            ...
            o.push(`\\begin\{adjustwidth\}{${config.stepmargin}cm}{${config.stepmargin}cm}`)
            o.push(text);
            o.push('\\end\{adjustwidth\}');
        ...
        case 'CODE':  
          ...
          const xleft = (fencecmd.n) ? N_lstlisting_numbers_xleftmargin : 0;
