    ...
    for (var block of all) {
      ...
      switch (sig) {
        ...
        case 'ITEM': {
          ...
          text = text.join('\n');
          text = this.unmask(text);
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${this.xleft};font-size:${this.xsize};'>`);
        ...
        case 'TEXT': {
          var text = data;
          o.push(`<div id='${id}' class='DIV' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' >`);
          o.push(`<p class='P TEXT' >`);
          var v;
...
///~~~
  ...
  toEquation(o,id,sig,dept,fname,row1,row2,data,fencecmd,isalignequalsign) {
    o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='' >`);
