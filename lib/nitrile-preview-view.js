...
class NitrilePreviewView {
  ...
  refreshView() {
    ...
    if (this.isarticle) {
      ...
      this.htmls.push(`</p>`);
      this.autonum.start();
      this.htmls = this.parser.translateHtml(this.autonum,this.config,this.blocks,this.isarticle,0,0,this.htmls);
      this.autonum.end();
      ...
      for (var i=0; i < this.subs.length; ++i) {
        this.htmls = this.parser.translateHtml(this.autonum,this.config,this.subs[i].flow[0],this.isarticle,this.subs[i].subrow,this.subs[i].sublevel,this.htmls);
      }
      this.autonum.end();
      this.htmls.push(`</main>`);
