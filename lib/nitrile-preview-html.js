      ...
      switch (sig) {
        ...
        case 'HDGS': {
          ...
          switch (cat) {
            case 0:
              ...
              o.push(`<small style='position:absolute; '><mark fName='${fname}' dept='${dept}'>[${id}]</mark>${hidden?"(hidden)":""}</small>`);
              o.push(`</h1>`);
              break;
            case 1:
              heading = 'SECTION';
        ...
        case 'CODE': {
          ...
          if (fencecmd.listing) {
            ...
            o.push(`<figcaption style='position:relative; '> Listing ${fig}: ${this.unmask(caption)} <small style='position:absolute; '>[${id}]</small> </figcaption>`);
        ...
        case 'PICT': {
          ...
          if (fencecmd.figure) {
            o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
            o.push(`<figure style='margin:1em 0'>`);
            o.push(`<figcaption style='position:relative; '> Figure ${fig}: ${this.unmask(caption)} <small style='position:absolute; '>[${id}]</small> </figcaption>`);
            for (var j in text) {
              var pp = text[j];
        ...
        case 'EQTN': {
          ...
          if (text.length == 1) {
            for (var s of text) {
              ...
              o.push(`<span style='display:block;text-align:center;position:relative'>${s}<span style='position:absolute;right:0px;'>(${fig})<small style='position:absolute; '>[${id}]</small></span></span>`);
            }
          } else if (text.length > 1) {
            var j = 0;
            for (var s of text) {
              s = this.tokenizer.parse(s,true);
              o.push(`<span style='display:block;text-align:center;position:relative'>${s}<span style='position:absolute;right:0px;'>(${fig}${this.toSubfigNum(j)})<small style='position:absolute; '>[${id}]</small></span></span>`);
              j += 1;
            }
          }
          o.push(`</p>`);
