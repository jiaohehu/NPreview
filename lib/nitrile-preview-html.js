  ...
  translateHtml (all,config,ispreview=false,editorrow=-1,editorcolumn=-1) {
    ...
    for (var block of all) {
      ...
      switch (sig) {
        ...
        case 'DLST': {
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' >`);
          o.push(`<dl class='P' >`);
        ...
        case 'PLST': {
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; margin-left:${0}cm'>`);
          o.push(`<p class='P' >`);
          for (var item of data) {
        ...
        case 'VERB':  
          ...
          text = text.join('\n');
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='position:relative;font-size:${this.xsize};'>`);
          o.push(`<pre class='PRE' >${text}</pre>`);
          o.push(`</div>`);
          o.push('');
          break;
        ...
        case 'ITEM': {
          ...
          text = text.join('\n');
          text = this.unmask(text);
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; margin-left:${this.xleft}; font-size:${this.xsize};'>`);
          o.push(`<p class='P' >${text}</p>`);
          o.push(`</div>`);
          o.push('');
          break;
        }
        ...
        case 'PARA': {
          var text = data;
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; ; margin-top:2em; margin-bottom:0;'>`);
          o.push(`<p class='P' >`);
          text = this.unmask(text);
          o.push(text);
          o.push('</p>');
        ...
        case 'PRIM': {
          ...
          text = this.unmask(text);
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; margin-bottom:0; '>`);
          o.push(`<p class='P' >`);
        ...
        case 'TEXT': {
          var text = data;
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; ; margin-top:0; margin-bottom:0;'>`);
          o.push(`<p class='P' >`);
          var v;
        ...
        case 'CITE': {
          ...
          text = text.map( x => this.escape(x) );
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; '>`);
          o.push(`<p class='P' ' >`);
          o.push(text.join('<br/>'));
          o.push(`</p>`);
          o.push(`</div>`);
        ...
        case 'TBLR': {
          ...
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle} font-size:${this.xsize} '>`);
          o.push(text);
          o.push('</div>');
          o.push('');
          break;
        ...
        case 'center': {
          ...
          o.push(`<p class='P' text-align:center; margin:0; ' >`);
          o.push(text);
          o.push(`</p>`);
          o.push('</div>');
          o.push('');
        ...
        case 'flushright': {
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; '>`);
          var text = this.unmask(data);
          o.push(`<p class='P' text-align:right; margin:0; ' >`);
          o.push(text);
          o.push(`</p>`);
          o.push('</div>');
          o.push('');
        ...
        case 'flushleft': {
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; '>`);
          var text = this.unmask(data);
          o.push(`<p class='P' text-align:left; margin:0; ' >`);
          o.push(text);
          o.push(`</p>`);
          o.push('</div>');
          o.push('');
        ...
        case 'DIAG': {
          if (star) {
            ...
            o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; '>`);
            o.push(`<p class='P' style='background-color:white;' >`);
        ...
        case 'dt': {
          ...
          for(var i=0; i < text.length; i+=2) {
            ...
            o.push(`<dt class='DT' >${dt}</dt>`);
            o.push(`<dd class='DD' style='margin-left:${this.xleft}; '>${dd}</dd>`);
          }
          o.push('</dl>');
          o.push('</div>');
          o.push('');
        ...
        case 'verb': {
          ...
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; '>`);
          o.push(`<p class='P' style='box-sizing:border-box; '>`);
  ...
  */
  ...
  ref (str) {
    ...
    for (var j=0; j < this.blocks.length; ++j) {
      ...
      var saveas = saveas || '';
      if (fencecmd.label) {
        var base_label = `${base}-${fencecmd.label}`;
        if( str.localeCompare(base_label)===0) {
          var idnum = fencecmd.idnum;
          break;
        }
      }
  ...
  toEquation(o,id,sig,dept,fname,row1,row2,data,fencecmd,isalignequalsign) {
    ...
    for (var bl of bls) {
      ...
      if (!star && j===1) {
        ...
        var numtext = `<span style='position:absolute;right:0pt;'>(${idnum}${subnum})</span>`;
      } else {
        var numtext = '';
      }
      var s0 = bl.join(' ');
