...
console.log(`${id}:${row1}:${row2}:${dept}:${fig}:${caption}`);
      switch (sig) {
        case 'FILE': {
          ...
          switch (cat) {
            case 0:
              if (isarticle) {
                ...
                heading = 'CHAPTER';
                section = id;
                o.push(`<h1 id='${id}' class='${heading}' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
            ...
            case 1:
              heading = 'SECTION';
              section = id;
              o.push(`<h2 id='${id}' class='${heading}' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
            ...
            case 2:
              heading = 'SUBSECTION';
              section = id;
              o.push(`<h3 id='${id}' class='${heading}' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push(`</h3>`);
              break;
            case 3:
              ...
              section = id;
              o.push(`<h4 id='${id}' class='${heading}' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push(`</h4>`);
              break;
            case 4:
              ...
              section = id;
              o.push(`<h5 id='${id}' class='${heading}' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push('<p>');
            ...
            default:
              ...
              section = id;
              o.push(`<h6 id='${id}' class='${heading}' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push('<p>');
              o.push(`&#160; &#160; &#160; <b>${this.escape(text)}</b> &#160;`);
        ...
        case 'CODE': {
          ...
          if (fencecmd.listing) {
            o.push(`<div id='${id}' class='${sig}' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
            o.push(`<figure>`);
            o.push(`<figcaption>Listing ${fig}: <small><mark>[${id}]</mark></small> ${this.unmask(caption)}</figcaption>`);
        ...
        case 'PICT': {
          ...
          if (fencecmd.figure) {
            o.push(`<div id='${id}' class='${sig}' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
            o.push(`<figure>`);
            o.push(`<figcaption>Figure ${fig}: <small><mark>[${id}]</mark></small> ${this.unmask(caption)}</figcaption>`);
            for (var j in text) {
              var pp = text[j];
