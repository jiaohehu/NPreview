    ...
    for (var block of all) {
      ...
      switch (sig) {
        case 'PART': {
          ...
          chaps.push(['PART',id,label_text,dept,text,o.length,this.saveas,this.refid]);
        ...
        case 'HDGS': {
          ...
          if (!this.isreport) {
            switch (hdgn) {
              ...
              case 1:
                heading = 'SECTION';
                chaps.push([heading,id,label_text,dept,text,o.length,this.saveas,this.refid]);
        ...
        case 'VERB':  
          ...
          if (this.xname === 'listing') {
            ...
            text = text.join('\n');
            text = `<pre>${text}</pre>`;
            o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='font-size:${this.xsize}'>`);
        ...
        case 'SAMP': {
          ...
          if (this.xparatype === 0) {
            ...
            text = text.join('\n');
            o.push(`<ul id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${this.xleft};font-size:${this.xsize};padding-left:0;list-style-position:outside;' >${text}</ul>`);
            o.push('');
          }
        ...
        case 'TEXT': {
          var text = data;
          var v;
          if (this.xparatype===0 && blockcount == 1) {
            text = this.unmask(text);
        ...
        case 'QUOT': {
          ...
          o.push(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${this.xleft};margin-right:${this.xleft};font-size:${this.xsize};'>`);
          o.push(`${lq}${text}${rq}`);
          o.push(`</p>`);
          o.push('');
          break;
        ...
        case 'IMGS': {
          ...
          o.push(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='display:grid;grid-template-columns:repeat(${column},1fr);grid-gap:1rem;' >`);
          images.forEach(x => {
              var [image,src,sub] = x;
              sub = this.unmask(sub);
              o.push(`<span style='display:inline-block;text-align:center;'><img src='./${src}' style='vertical-align:text-bottom;width:100%;' alt='${src}'/><small>${sub}</small></span>`);
          });
          o.push('</p>');
          o.push('');
          ...
          images.forEach(x => {
              var [image,src,sub] = x;
              chaps.push(['image', '', '', '', src, o.length, this.saveas,this.refid]);
          });
        ...
        case 'TABB':
          ...
          var text = s.join('\n');
          o.push(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='display:grid;grid-template-columns:repeat(${ncols},1fr);' >`);
          o.push(text);
          o.push('</p>');
          o.push('');
          break;
        ...
        case 'TBLR':  
          ...
          if (sig==='TBLR'&&this.xname === 'table') {
            o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' border='0' style='margin-left:auto;margin-right:auto; ' >`);
            o.push(`<figcaption style='margin-left:auto;margin-right:auto;text-align:center;' > Table ${this.xidnum} : ${this.caption_text} </figcaption>`);
            o.push(`<table border='0' style='font-size:${this.xsize};border-collapse:collapse;margin-left:auto;margin-right:auto; ' >`);
          } else if (sig==='LONG'&&this.xname === 'table') {
            o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' border='0' style='width:100%; ' >`);
            o.push(`<figcaption style='margin-left:auto;margin-right:auto;text-align:center;' > Table ${this.xidnum} : ${this.caption_text} </figcaption>`);
            o.push(`<table border='0' style='font-size:${this.xsize};border-collapse:collapse;width:100%; ' >`);
          } else if (sig==='TBLR') {
            o.push(`<table id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' border='0' style='font-size:${this.xsize};margin-left:auto;margin-right:auto; ' >`);
          } else if (sig==='LONG') {
