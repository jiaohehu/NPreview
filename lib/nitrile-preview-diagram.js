...
class NitrilePreviewDiagram {
  ...
  constructor (parser) {
    this.re_command = /^(drawgrid|drawarrow|drawdblarrow|drawline|drawrect|drawtriangle|drawdot|drawcircle|save|set|label(ctr|right|left|bot|top|topleft|topright|botleft|botright))/;
