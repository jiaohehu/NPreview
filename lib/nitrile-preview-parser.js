...
//console.log(block);
    ...
    /// Following is to take care of the case where the first
    /// block is a HDGS/0 block. This could happen where 
    /// a LABEL must be included with a heading. 
    /// However, per NITRILE rule the first HDGS must be a HDGS/0 block.
  ...
  */
  ...
  parse_tabb(data) {
    ...
    ///the following arrange 'data' so that it is col oriented
