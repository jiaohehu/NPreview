...
class NitrilePreviewParser {
  ...
  read_para (lines) {
    ...
    if(type == 'pict'){
      data = this.parse_pict(text);
    } 
    else if (type == 'tabr'){
      data = this.parse_tabb(text);
    } 
    else if (type == 'tabb'){
      data = this.parse_tabb(text);
    }
      ...
      data = this.parse_plst(text);
    }
    else if(type == 'hlst'){
      data = this.parse_hlst(text);
    }
    else if(type == 'tlst'){
      data = this.parse_tlst(text);
console.log(data);
    }
    else if(type == 'dlst'){
      data = this.parse_dlst(text);
    }
    else if(type == 'long'){
      data = this.parseLongPara(text);
    }
    else if(type == 'samp'){
