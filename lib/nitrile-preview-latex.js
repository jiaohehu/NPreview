...
const { NitrilePreviewDiagramMETAPOST } = require('./nitrile-preview-diagrammetapost');
    ...
    for (var block of all) {
      ...
      switch (sig) {
        ...
        case '_diagram': {
          ...
          o.push('beginfig(1)');
          o.push((new NitrilePreviewDiagramMP(this)).toMetaPost(data));
          o.push('endfig')
        ...
        case 'diagram': {
          var [text] = new NitrilePreviewDiagramMETAPOST(this).parse(data);
          o.push('\\begin{mplibcode}');
          o.push('beginfig(1)');
          o.push(text);
          o.push('endfig')
