...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  localy(y) {
    ...
    ///   SVG coords.
    ///
 console.log('0 james localy','y=',y);
    y *= this.refs;
 console.log('0 james localy','y=',y);
    y += this.refy;
 console.log('0 james localy','this.refy=',this.refy);
 console.log('0 james localy','y=',y);
...
console.log('a james','x=',x);
console.log('a james','y=',y);
    ...
    var gapx = this.config.labelgapx;
    var gapy = this.config.labelgapy;
console.log('james','gapx=',gapx);
console.log('james','gapy=',gapy);
    var dx = 0;
    var dy = 0;
    if (justi==='lrt') {
...
console.log('james','dx=',dx);
console.log('james','dy=',dy);
    x += dx;
    y += dy;
