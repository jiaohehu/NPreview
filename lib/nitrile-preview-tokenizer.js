...
class NitrilePreviewTokenizer {
  ...
  toInnerSvg (v, compact=false) {
    ...
    if (v === undefined || v === null) {
      ...
      return [0.6*fs.this,this.fs,this.fs/2,s,0,0,''];
    } else if (v === '') {
      return [0,0,0,'',0,0,''];
      ...
      switch (v[0]) {
        ...
        case '\\leftright':
          ...
          for (let result of results) {
            ...
            if (i === 1) {
              ...
              //
              // The q is set when it is after \lim, \int, and \sum such that sometime an extra
              // gap is needed to place it after the summation symbol, or not, so q= makes it
              // flexible. IT is set to 2 when it is after \int. It seems that \int symbol
              // would protrude much further to the right-side and thus we need to move further
              // away from it after encountering it
              //
              //
        ...
        case '\\sqrt':
          ...
          var n = v[1];
          /// \sqrt{x} or \sqrt[4]{x}
          var [idrad_, wrad_] = this.findIdByElement('\\sqrt');//wrad_ contains the width of the radical symbol
          var [w_,h_,mid_,s_,g_,q_,id_] = this.toInnerSvg(v[2],compact);
          var lead = wrad_ * this.fs/12;
          ...
          if(1){
            ...
            o.push(`<line x1='${lead}pt' y1='0.3pt' x2='${w}pt' y2='0.3pt' style='stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
        ...
        case '\\frac':
          ...
          if (w1_ < w2_) {
            ...
            o.push(s2_);
            o.push(`</svg>`);
            o.push(`<line x1='0pt' y1='${1.5+h1_}pt' x2='${w}pt' y2='${1.5+h1_}pt' style='stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
            var newv = [w,h,mid,o.join('\n'),0,0,''];
          } else {
            var dx = 1+ (w1_ - w2_)/2;
  ...
  to_text_element(text,keepwhitespace){
    ...
    /// display it as text.
    var s = `<text x='0' y='0' dy='${this.dy}em' textLength='${totalw}pt' lengthAdjust='spacingAndGlyphs' style='stroke:none;fill:inherit;font-size:${this.fs}pt'>${newtext}</text>`
    var w = totalw;
    var h = this.fs;
    var mid = this.fs/2;
  ...
  toSvg (v) {
    ...
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:${this.fs}pt;' id='myA'>&#x1D44E;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:${this.fs}pt;' id='myB'>&#x1D44F;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:${this.fs}pt;' id='myC'>&#x1D450;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:${this.fs}pt;' id='myD'>&#x1D451;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:${this.fs}pt;' id='myN'>&#x1D45B;</text>
    ///<text dy='1em' style='stroke:none; fill:inherit; font-size:${this.fs}pt;' id='mySQRT'>&#x221A;</text>
    ///<text dy='1em' style='stroke:none; fill:inherit; font-size:${this.fs}pt;' id='myOVERLINE'>&#x0305;</text>
    ///<text dy='.7em' style='stroke:none; fill:inherit; font-size:${this.fs}pt;' id='myPLUS'>+</text>
    ///
...
stroke='currentColor'
viewBox='0 0 ${vw} ${vh}'
style='vertical-align:baseline;outline:0px solid orange'
role='img'
focusable='false' >
<defs>
${defs.join('\n')}
