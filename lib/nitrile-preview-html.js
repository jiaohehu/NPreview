...
`;
  ...
  do_imgs(block) {
    ...
    if (this.xname === 'figure') {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};'>`);
      o.push(`<figcaption style='text-align:left;' > <b>Figure ${this.xidnum}</b> : ${this.caption_text} </figcaption>`);
      o.push(s.join('\n'));
      o.push('</figure>');
    } else {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};'>`);
  ...
  do_tblr_long(block){
    ...
    if (this.xname === 'table') {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};' >`);
      o.push(`<figcaption style='text-align:left;' > <b>Table ${this.xidnum}</b> : ${this.caption_text} </figcaption>`);
      o.push(text);
      o.push(`</figure>`);
    } else {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};' >`);
