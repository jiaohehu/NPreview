...
class NitrilePreviewDiagram {
  ...
  initSettings() {
    ...
    this.def_dotsize = this.dotsize = '5';
    ...
    this.def_rotation = this.rotation = 0;
    this.def_bigarcflag = this.bigarcflag = 0;
    this.def_anglearcradius = this.anglearcradius = 0.5;
    this.def_anglearclabeloffset = this.anglearclabeloffset = 0.75;
...
console.log('james: re_var_command: line=',line);
console.log('james: re_var_command: coords=',coords);
        ...
        if (segs.length > 1) {
          for (var i = 0; this.valid(segs, i); ++i) {
            ...
            if (this.re_word.test(seg)) {
              ...
              o.push(`%***saved: ${seg}:=${this.coordsToString(this.variables[seg])}`);
              this.commands.push(this.do_comment(`%***saved: ${seg}:=${this.coordsToStr(this.variables[seg])}`));
              ///NOTE:Diabled:o.push(`path ${seg}; ${seg}:=${this.coordsToString(this.variables[seg])};`);
            }
          }
        } else if (this.re_word.test(symbol)) {
          this.variables[symbol] = coords;
          o.push(`%***saved: ${symbol}:=${this.coordsToString(this.variables[symbol])};`);
      ...
      if ((v = this.re_set_command.exec(line)) !== null) {
        ...
        if (key === 'x-radius') { this.xradius = this.assertFloat(val, this.def_xradius, 0.1, 100); } //suchas '2'
        if (key === 'y-radius') { this.yradius = this.assertFloat(val, this.def_yradius, 0.1, 100); } //suchas '1'
        if (key === 'position') { this.position = this.toString(val, this.def_position); } //suchas 'top'
        if (key === 'rotation') { this.rotation = this.toFloat(val, this.def_rotation, -90, 90); } //suchas '30.5'
        if (key === 'big-arc-flag') { this.bigarcflag = this.assertInt(val, this.def_bigarcflag, 0, 1); } //suchas '0'
        if (key === 'angle-arc-radius') { this.anglearcradius = this.assertFloat(val, this.def_anglearcradius, 0.1, 100); } //suchas '0.5'
        if (key === 'angle-arc-label-offset') { this.anglearclabeloffset = this.assertFloat(val, this.def_anglearclabeloffset, 0.1, 10); } //suchas '1.0'
        if (key === 'stroke-width') { this.linewidth = this.assertLength(val, this.def_linewidth); } ///such as '0', '0.1', '1pt', '1mm'
        ...
        if (key === 'tick-width') { this.tickwidth = this.assertLength(val, this.def_tickwidth); } ///such as '1pt' or '1mm'
      ...
      if ((v = this.re_label_command.exec(line)) !== null) {
        ...
        for (var i = 0; this.valid(coords, i); ++i) {
          ...
          o.push(`label${opt} (btex {${tex_label}} etex, (${x}*u,${y}*u)) ${withcolor};`);
        }
        continue;
      }
      ...
      if ((v = this.re_apple_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_apple(opt,'',coords));
        this.lastcoords = coords;
        ...
        for (var i = 0; this.valid(coords, i); i++) {
          ...
          var myshifted = '';
          if (opt === '.top') {
            myshifted = 'shifted(-0.5,0)';
          } else if (opt === '.bot') {
            myshifted = 'shifted(-0.5,-1)';
          } else if (opt === '.rt') {
            myshifted = 'shifted(0,-0.5)';
          } else if (opt === '.lft') {
            myshifted = 'shifted(-1,-0.5)';
          } else {
            myshifted = 'shifted(-0.5,-0.5)';
          }
          if (this.fillcolor) {
            o.push(`fill (${mypath}) ${myshifted} shifted(${x},${y}) scaled(u) ${this.fills()};`);
          }
          if (typeof this.linewidth == 'number' && this.linewidth ) {
            o.push(`draw (${mypath}) ${myshifted} shifted(${x},${y}) scaled(u) ${this.draws()};`);
          }
        }
        continue;
      }
      if ((v = this.re_basket_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_basket(opt,'',coords));
        this.lastcoords = coords;
      ...
      if ((v = this.re_crate_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_crate(opt,'',coords));
        this.lastcoords = coords;
      ...
      if ((v = this.re_parallelgram_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_parallelgram(opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
          z0 = this.local(z0);
      ...
      if ((v = this.re_rhombus_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_rhombus(opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
        }
        continue;
      ...
      if ((v = this.re_trapezoid_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_trapezoid(opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
        }
        continue;
      ...
      if ((v = this.re_rect_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_rect(opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
          z0 = this.local(z0);
      ...
      if ((v = this.re_rrect_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_rrect(opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
          z0 = this.local(z0);
      ...
      if ((v = this.re_brick_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_brick(opt,'',coords));
        this.lastcoords = coords;
      ...
      if ((v = this.re_drawrevarrow_command.exec(line)) !== null) {
        ...
        if (!dstr) {
          ...
          var withscaled = `xscaled(${this.refsx}) yscaled(${this.refsy})`;
          var withshifted = `shifted(${this.refx},${this.refy})`;
          o.push(`drawarrow reverse(${dstr}) ${withscaled} ${withshifted} scaled(u) ${this.draws()};`);
        }
        continue;
      }
      ...
      if ((v = this.re_drawanglearc_command.exec(line)) !== null) {
        ...
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_drawanglearc(anglearc_opt,label,coords));
        this.lastcoords = coords;
        if (anglearc_opt === '') {
      ...
      if ((v = this.re_circle_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_circle(circle_opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
          z0 = this.local(z0);
      ...
      if ((v = this.re_halfcircle_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_halfcircle(opt,'',coords));
        this.lastcoords = coords;
        continue;
      }
      if ((v = this.re_quadrant_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_quadrant(opt,'',coords));
        this.lastcoords = coords;
        continue;
      }
      if ((v = this.re_octant_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_octant(opt,'',coords));
        this.lastcoords = coords;
        continue;
      }
      ...
      if ((v = this.re_tick_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_tick(tick_opt,'',coords));
        this.lastcoords = coords;
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
          z0 = this.local(z0);
      ...
      if ((v = this.re_radical_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_radical(opt,'',coords));
        this.lastcoords = coords;
        ///var mypath='(3,2)--(0,2)--(0,0)--(3,0)--(3,2)--(0,2)--(1,3)--(4,3)--(3,2)--(3,0)--(4,1)--(4,3)--cycle';
      ...
      if ((v = this.re_protractor_command.exec(line)) !== null) {
        ...
        var line = v[2];
        var coords = this.readCoordsLine(o, line);
        this.commands.push(this.do_protractor(opt,'',coords));
        this.lastcoords = coords;
        var mypath = '(0,0)--(1,0)--(1,0.5)--(0,0.5)--cycle';
        for (var i = 0; this.valid(coords, i); i++) {
          z0 = this.point(coords, i);
  ...
  execFunction(o, line, fun_str, arg_str) {
    ...
    switch (fun_str) {
      ...
      case 'scatterpoints':
console.log('james: scatterpoints: entered');

        if (args.length == 5) {
console.log('james: scatterpoints: entered length=5');
...
console.log('james: scatterpoints: entered ret_val=',ret_val);
            }
          }
        }
        break;
...
console.log('james: readCoordsLine: returning ret_val=',ret_val);
    return ret_val;
  }
      ...
      if (this.re_coord.test(line) || this.re_cycle.test(line)) {
        ...
        if (Number.isFinite(x) && Number.isFinite(y)) {
          ...
          if (lastjoin === 'hobby') {
            hobby_p.push([x, y]);
            var tension = 1;
            var knots = makeknots(hobby_p, tension, false);
            mp_make_choices(knots[0]);
            ///console.log('james: hobby: knots.length=',knots.length);
            ///console.log('james: hobby: knots=',knots);
            coords.push([x, y, '']);
            var i = coords.length - 3;
            for (var i = 1; i < knots.length; ++i) {
              var j = coords.length - knots.length + i;
              ///console.log('james: hobby: j=',j);
              coords[j][2] = '..';
            ...
            ///console.log('james: hobby: coords=',coords);
          } else {
            coords.push([x, y, '']);
            lastpt[0] = x;
            lastpt[1] = y;
        ...
        if (d.length == 2) {
          ...
          if (key === 'angledist') {
            ...
            if (val.length == 2) {
              ...
              y = lastpt[1] + dy;
              lastjoin = '';
              coords.push([x, y, lastjoin, x1, y1, x2, y2]);
              lastpt[0] = x;
              lastpt[1] = y;
            }
          }
  ...
  drawlineFlag() {
    ///NOTE: return 'true' if current setting of this.linewidth expresses
    ///that a line should be drawn. A line drawing is inhibited when
    ///this.linewidth is set to a number 0. But the default setting is
    ///a string that is empty. This setting denotes a default line width
    ///and the line should be drawn.
    if (typeof this.linewidth === 'string' && this.linewidth.length==0) {
      return true;
    }
    if (this.linewidth == 0) {
      return false;
