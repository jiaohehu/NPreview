...
`
  ...
  translateHtml (all,config,ispreview=false,editorrow=-1,editorcolumn=-1) {
    ...
    for (var block of all) {
      ...
      this.fs = fencecmd.fs;
      console.log('james: setting from fencecmd: this.fs =',this.fs);
...
//console.log(data);
        ...
        case 'tabular':
          ...
          var fs = this.toCssFontsize(fencecmd.fs);
          ...
          o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle} font-size:${fs} '>`);
          o.push(`${showidtext}`);
          o.push(text);
          o.push('</div>');
          o.push('');
