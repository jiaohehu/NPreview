...
class NitrilePreviewParser {
  ...
  toBLOCKS(lines,fname,plevel,o) {
    ...
    */
    ...
    if (lines.length && lines[0] === '% !BOOK') {
      o.push(['',0,lines.length-1,'!BOOK',0,lines,lines,refname,caption,fname,plevel]);
    ...
    while (lines.length > 0) {
      ...
      if (flags.verbatim && this.re_four_spaces.test(para[0])) {
        ...
        var fencecmd = {};
        data = [data,fencecmd];
        o.push([id,row,row2,'VERB',0,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '```') {
        ...
        data = [data,fencecmd];
        o.push([id,row,row2,'CODE',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '~~~') {
        ...
        var [data,fence,fencecmd] = this.trimFences(data);
        data = [data,fencecmd];
        o.push([id,row,row2,'VERB',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '---') {
        var [data, n] = this.trimPara(para);
        var [data,fence,fencecmd] = this.trimFences(data);
        o.push([id,row,row2,'VRSE',n,data,para,refname,caption,fname,plevel]);
        continue
      }
      ...
      if (the_fence === '///') {
        ...
        data = [data,fencecmd];
        o.push([id,row,row2,'PICT',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '===') {
        ...
        data = [data,fencecmd];
        o.push([id,row,row2,'TABB',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '<<<') {
        ...
        o.push([id,row,row2,'TERM',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '\"\"\"') {
        ...
        o.push([id,row,row2,'QUOT',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '@@@') {
        ...
        data = [data,fencecmd];
        o.push([id,row,row2,'SPEC',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (this.re_hyphen_hyphen.test(para[0])) {
        ...
        o.push([id,row,row2,'DESC',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        o.push([id,row,row2,'PRIM',0,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        o.push([id,row,row2,'SECO',0,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        o.push([id,row,row2,'PLST',n,data,para,refname,caption,fname,plevel]);
        continue
      }
      ...
      if ((v = re.exec(para[0])) !== null) {
        ...
        o.push([sid,row,row2,'HDGS',0,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (nblocks == 1) {
        ...
        o.push([id,row,row2,'HDGS',0,data,para,refname,caption,fname,plevel]);
        continue;
      }
      ...
      if (true) {
        var [data, n] = this.trimPara(para);
        var data = this.joinPara(data);
        o.push([id,row,row2,'',n,data,para,refname,caption,fname,plevel]);
        continue;
      }
  ...
  findIdForFname (fn, blocks) {
    ...
    */
    for (var block of blocks) {
      const [id,row1,row2,type,n,data,para,refname,caption,fname,plevel] = block;
      if (fname === fn) {
        if (type === 'HDGS') {
          if (data[0] === 0) {
            return id;
  ...
  toErrorBlock (str,fname,plevel) {
    ...
    */
    var refname = '';
    var caption = '';
    return ['',-1,-1,'HDGS',0,[0,str],[],refname,caption,fname,plevel];
