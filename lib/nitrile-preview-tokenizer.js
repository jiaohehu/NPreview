...
//console.log('s_=',s_);
        ...
        case '\\sup':
          ...
          if (!this.isinmatrix && this.isdisplaymath && v[1] === '\\sum'
            ...
            if (0) {
              ...
              o.push(`<svg x='0' y='0'         width='${nw1_}pt' height='${nh1_/2}pt' viewBox='0 0 ${wdtop_*1.333} ${12*1.333}' preserveaspectratio='none'>`);
              o.push(`<use xlink:href='#${idtop_}' />`);
              o.push(`</svg>`);
              o.push(`<svg x='0' y='${nh1_/2}' width='${nw1_}pt' height='${nh1_/2}pt' viewBox='0 0 ${wdbot_*1.333} ${12*1.333}' preserveaspectratio='none'>`);
      ...
      if (id === 'myINT') {
        ...
        var [idbot_,wdbot_,opbot_] = this.findIdByElement('\\intbot');
        var s = [];
        s.push(`<svg x='0' y='0'   width='${wdtop_}pt' height='6pt' viewBox='0 0 ${wdtop_*1.3333} ${12*1.3333}'>`);
        s.push(`<use xlink:href='#${idtop_}' />`);
        s.push(`</svg>`);
        s.push(`<svg x='0' y='6pt' width='${wdbot_}pt' height='6pt' viewBox='0 0 ${wdbot_*1.3333} ${12*1.3333}'>`);
