...
const pjson_fontvariants = require('./nitrile-preview-fontvariants.json');
    ...
    if (!v) {
      ...
      switch (v[0]) {
        ...
        case '\\sup':  
          ...
          o.push(s1_);
          o.push(`<svg x='${w1_}pt' y='-${nh2_*0.5}' width='${nw2_}pt' height='${nh2_}pt' viewbox='0 0 ${w2_*1.333} ${h2_*1.333}'>`);
          o.push(s2_);
          o.push(`</svg>`);
          return [w1_+nw2_,h1_+(nh2_*0.5),mid1_+(nh2_*0.5),o.join('\n')];
          break;
        ...
        case '\\sub':  
          ...
          o.push(s1_);
          o.push(`<svg x='${w1_}pt' y='${h1_-(nh2_*0.75)}pt' width='${nw2_}pt' height='${nh2_}pt' viewbox='0 0 ${w2_*1.333} ${h2_*1.333}'>`);
          o.push(s2_);
          o.push(`</svg>`);
          return [w1_+nw2_,h1_+(nh2_*0.25),mid1_,o.join('\n')];
          break;
        ...
        case '\\subsup':  
          ...
          o.push(s1_);
          o.push(`</svg>`);
          o.push(`<svg x='${w1_}pt' y='${supdx+h1_-(nh2_*0.75)}pt' width='${nw2_}pt' height='${nh2_}pt' viewbox='0 0 ${w2_*1.333} ${h2_*1.333}'>`);
          o.push(s2_);
          o.push(`</svg>`);
          o.push(`<svg x='${w1_}pt' width='${nw3_}pt' height='${nh3_}pt' viewbox='0 0 ${w3_*1.333} ${h3_*1.333}'>`);
          o.push(s3_);
          o.push(`</svg>`);
          return [w1_+this.max(nw2_,nw3_),h1_+(nh2_*0.25)+(supdx),mid1_+(supdx),o.join('\n')];
          break;
...
console.error(str);
        ...
        if (pjson_fontvariants[key]) {
          for (var c of str) {
            var val = pjson_fontvariants[key][c];
            if (val) {
