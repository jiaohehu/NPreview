...
`;
  ...
  do_samp(block) {
    ...
    if (!mode) {
      ...
      text = text.join('<br/>');
      text = `<li>${text}</li>`; 
      o.push(`<ul id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:${fencecmd.left}mm;margin-top:${this.xtop};margin-bottom:${this.xbot};font-size:${fencecmd.cssfontsize};padding-left:${fencecmd.left}mm;list-style-position:outside;' >${text}</ul>`);
      o.push('');
    }
    block.html = o.join('\n');
  }
  ...
  do_text(block) {
    ...
    ///output to 'o'
    o.push(`<p id='${id}' class='P TEXT' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:${left};margin-top:${this.xtop};margin-bottom:${this.xbot};text-indent:${csstextindent}' >${text}</p>`);
    o.push('');
    block.html = o.join('\n');
  }
  do_incl(block){
  ...
  do_imgs(block) {
    ...
    if (this.xname === 'figure') {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};'>`);
      o.push(`<figcaption style='text-align:left;margin-top:${this.xtop};margin-bottom:${this.xbot};' > <b>Figure ${this.xidnum}</b> : ${this.caption_text} </figcaption>`);
      o.push(s.join('\n'));
      o.push('</figure>');
    } else {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};'>`);
  ...
  do_tblr_long(block){
    ...
    if (this.xname === 'table') {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};' >`);
      o.push(`<figcaption style='text-align:left;margin-top:${this.xtop};margin-bottom:${this.xbot};' > <b>Table ${this.xidnum}</b> : ${this.caption_text} </figcaption>`);
      o.push(text);
      o.push(`</figure>`);
    } else {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};' >`);
  ...
  do_math(block) {
    ...
    if (fencecmd.name=='equation') {
      ...
      mydata = mydata.map((x,i) => {
          if(i==0) {
            var numtext = `<nobr>(<b>${this.xidnum}</b>)</nobr>&#160;&#160;&#160;`;
      ...
      mydata = mydata.map((x,i) => {
          var idnum = idnums[i];
          var numtext = `<nobr>(<b>${idnum}</b>)</nobr>&#160;&#160;&#160;`;
      ...
      mydata = mydata.map((x,i) => {
          ...
          var numtext = `<nobr>(<b>${idnum}</b>${subnum})</nobr>&#160;&#160;&#160;`;
          return `<td>${numtext}</td>${x}`;
      });
    } else {
      if (isalignequalsign) {
