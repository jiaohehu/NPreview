...
*/
  ...
  translateBlocks(translator) {

    const name = translator.name;
    translator.xconfig = this.config[name] || {};
...
*/
    for (var block of this.blocks) {
      ...
      translator.xblock = block;//the current block
      translator.xparser = parser;//the parser associated with this block
