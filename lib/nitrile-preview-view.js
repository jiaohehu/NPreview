...
///console.log(`image ${fsrc} changed`);
  ...
  updateBlocks() {
    ...
    this.parser.readFromLines(this.lines);
    this.parser.idenBlocks();
    this.title = this.parser.config.ALL.title || '';
    this.author = this.parser.config.ALL.author || '';
    this.refreshView();
  ...
  refreshView() {
    ...
    var opts = [];
    opts.push(`padding-left:1em`);
    opts.push(`padding-right:1em`);
    opts.push(`padding-top:1em`);
    opts.push(`padding-bottom:1em`);
    opts.push(`margin:0`);
