...
${j==n-1&&hlines.indexOf('b')>=0?'border-bottom:1px solid;':''} '>${x}</td>`);
  ...
  smooth (unsafe) {
    ...
    unsafe = unsafe
      ...
      .replace(/²/g,  "&#x00B2;")
      .replace(/³/g,  "&#x00B3;")
      .replace(this.re_all_sups, (match,p1,p2) => {
          switch(p2){
            // I^1
            case '0': return  `${p1}&#x2070;`; 
            case '1': return  `${p1}&#x00B9;`; 
      ...
      .replace(this.re_all_subs, (match,p1,p2) => {
          switch(p2){
            // I_1
            case '0': return `${p1}&#x2080;`;
            case '1': return `${p1}&#x2081;`;
      ...
      .replace(this.re_all_diacritics, (match,p1,p2) => {
          switch(p2){// a~dot, a~ddot, a~bar ...
      ...
      .replace(this.re_all_mathvariants, (match,p1,p2) => {
          // a~mathbb, a~mathbf, ...
          try{
      ...
      .replace(this.re_all_symbols, (match,p1) => {
          try{
  ...
  to_style(text,type) {
    ...
    switch (type) {
      case 'verb': {
        return `<code style='white-space:pre'>${text}</code>`;
        break;
      }
      case 'code': {
