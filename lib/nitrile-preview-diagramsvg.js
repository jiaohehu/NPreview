  ...
  do_circle(opt,txt,coords) {
    ...
    for (var i = 0; this.valid(coords, i); i++) {
      ...
      if (opt==='') {
        ...
        var x1 = radius * Math.cos(this.angle1 / 180 * Math.PI);
        var y1 = radius * Math.sin(this.angle1 / 180 * Math.PI);
        var x2 = radius * Math.cos(this.angle2 / 180 * Math.PI);
        var y2 = radius * Math.sin(this.angle2 / 180 * Math.PI);
        x1 += x;
        y1 += y;
        x2 += x;
        y2 += y;
        ...
        s.push(`<line x1='${x1}' y1='${y1}' x2='${x2}' y2='${y2}' ${this.ticks()}/>`);
      } else if (opt === '.arc') {
