      ...
      switch (sig) {
        ...
        case 'CODE': {
          ...
          if (fencecmd.listing) {
            ...
            o.push(`<figcaption style='position:relative; '>Listing ${fig}: <small style='position:absolute; '>[${id}]</small> ${this.unmask(caption)}</figcaption>`);
        ...
        case 'PICT': {
          ...
          if (fencecmd.figure) {
            o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
            o.push(`<figure style='margin:1em 0'>`);
            o.push(`<figcaption style='position:relative; '>Figure ${fig}: <small style='position:absolute; '>[${id}]</small> ${this.unmask(caption)}</figcaption>`);
            for (var j in text) {
              var pp = text[j];
