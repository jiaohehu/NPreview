    ...
    for (var block of blocks) {
      ...
      switch (sig) {
        ...
        case 'VRSE': {
          ...
          o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='margin:1em 0; margin-left:${left}'>`);
...
=======
        ...
        case 'FIGE': {
          ...
          o.push(`<figure style='text-align:center; ${this.paracssstyle}' >`);                
>>>>>>> bab9fedad9cc098e947b09463c7ef230e591c24c
...
>>>>>>> bab9fedad9cc098e947b09463c7ef230e591c24c
        ...
        case 'TABB': {
          ...
          for (var pp of text) {
            ...
            if (rowcount == 1) {
              pp = pp.map(x => `<th style='text-align:center; ${this.thcssstyle} '>${x}</th>`);
              o.push(pp.join(''));
            } else {
        ...
        case 'TERM': {
          ...
          if (fencecmd.table) {
            var text = data;
            o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='margin:1em 0; margin-left:${left}'>`);
            o.push(`<table width='100%' style='${this.paracssstyle} ${this.tablecssstyle} ' >`);         
            o.push(`<colgroup>`);
            o.push(`<col width='30%'/>`);
            o.push(`<col width='70%'/>`);
            o.push(`</colgroup>`);
...
>>>>>>> bab9fedad9cc098e947b09463c7ef230e591c24c
                ...
                o.push(`<tr style='${this.trcssstyle}' ><td style='text-align:left'>${dt}</td><td style='text-align:left'>${dd}</td></tr>`);
              }
            }
            o.push(`</tbody>`);
            o.push(`</table>`);
            ...
            for(var i=0; i < text.length; i+=2) {
              ...
              o.push(`<dd style='padding-left:0cm; ${this.ddcssstyle}'>${dd}</dd>`);
            }
            o.push('</dl>');
            o.push('</div>');
            o.push('');
        ...
        case '': {
          if (this.isSkipping(config,dept)) break;
          o.push(`<div id='${id}' class='TEXT' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='margin:1em 0; margin-left:${left}'>`);
          var text = this.unmask(data);
          if (config.parskip) {
            o.push(`<p style='${this.paracssstyle}' >`);
            o.push(`${text}`);
    ...
    switch (type) {
      ...
      case 'ref': {
        ...
        if (this.xrefs[label]) {
          ...
          var ref_texts = ref_texts.map( ref_text => `<a href='#${label}' style='${this.acssstyle}' >${this.escape(ref_text)}</a>`);
          var o = [];
