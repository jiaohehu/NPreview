...
//console.log('s_=',s_);
  ...
  toSvg (v,addoutline = false) {
    ...
    var rate = this.toFontRate(this.parser.fs);///this.parser.fs= 'normalfont', 'small', 'fontnotesize', etc.
    if (this.parser.xbodyfontsizept) {
      var rate2 = this.parser.xbodyfontsizept/12;
      rate = rate*rate2;
    }
    var vw = w*1.3333;
    var vh = h*1.3333;
