...
console.log(sig,nread,nlines,row1,row2)
console.log(block);
  ...
  read_para (lines) {
    ...
    /// slice off possibly captions

    para = para.concat(lines.slice(0,i));
    lines = lines.slice(i);
    ...
    if(type == 'pict'){
      ...
      return {para,lines,sig,caption,label,rows};
    } 
    else if (type == 'tabr'){
      var cols = this.parse_tabb(body);
      return {para,lines,sig,caption,label,cols};
    } 
    else if (type == 'tabb'){
      var cols = this.parse_tabb(body);
      return {para,lines,sig,caption,label,cols};
