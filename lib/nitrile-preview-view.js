...
console.log(`load image from file: ${imgid}, ${src}`);
  ...
  toHtml() {
    ...
    /// refresh again if xrefs is differet than last time
    if (this.xrefs_changed) {
      this.refreshView();
    }
...
`;
        ...
        data = await epub.generateAsync(this.parser.escape(this.title),this.parser.escape(this.author),this.htmls,this.chaps,this.imageidmap,this.imagemap,this.isarticle,this.dirname());
