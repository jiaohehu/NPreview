    ...
    for (var block of blocks) {
      ...
      switch (type) {
        ...
        case 'LSTG': {
          ...
          o.push(`\\begin\{adjustwidth\}{${left}}{}`)
          this.lstnum += 1;
          o.push(`Listing ${this.lstnum}: ${this.unmask(ins_text)}\\\\`)
          for (var i=0; i < data.length; ++i) {
            ...
            if (i === data.length-1) {
              o.push(`\\mbox{\\ttfamily{}{\\footnotesize{}${linenum}}${text}}`);
    ...
    */
    ...
    for (var line of data) {
      ...
      if (v) {
        ...
        var parser1 = new NitrilePreviewParser(); /// use a new parser for
                                                 /// each new sub-document
    ...
    /// use a LATEX translator
    var translator = new NitrilePreviewLatex();
    var lines1 = translator.translate(blocks1,false);
    return `\% \!TEX program = lualatex
\\documentclass{${documentclass}}
\\usepackage{luatexja-fontspec}
\\usepackage{luatexja-ruby}
