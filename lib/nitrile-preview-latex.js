...
class NitrilePreviewLatex extends NitrilePreviewParser {
  ...
  do_verb(block){
    ...
    if(label){
      caption = `Listing ${this.xidnum} : ${caption}${this.latexlabelcmd}`;
    }
    var text = body;
    var s = [];
    if (this.xnumbers) {
  ...
  do_tabr(block){
    ...
    caption=this.caption_text;
    if(label){
      caption = `Table ${this.xidnum} : ${caption}${this.latexlabelcmd}`;
    }
    var s = [];
  ...
  do_diag(block){
    ...
    caption=this.caption_text;
    if(label){
      caption = `Figure ${this.xidnum} : ${caption}${this.latexlabelcmd}`;
    }
    if(0){
