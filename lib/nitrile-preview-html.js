    ...
    for (var block of blocks) {
      ...
      switch (sig) {
        ...
        case 'VERB':
          ...
          o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='${this.divcssstyle}; margin-left:${left}cm'>`);
          o.push(`${showidtext}`);
          o.push(`<p style='${this.paracssstyle}; border:1px solid #333; padding:2px; box-sizing:border-box; '>`);
          ...
          ///o.push( `<img style='border:1px solid #333; padding:2px; box-sizing:border-box; width:100%; max-width:${vw}px;' src="data:image/svg+xml;charset=UTF-8,${encodeURIComponent(out)}" />` );
        ...
        case 'PICT':
          ...
          if (fig) {
            ...
            o.push(`<p style='${this.paracssstyle}; border:1px solid #333; text-align:center; ' >`);
    ...
    for (var pp of text) {
      ...
      var kk = pp.map( x => {
          ...
          if (this.view && this.view.hasImageId(src)) {
            ...
            this.imgid += 1;///auto assign a new id
