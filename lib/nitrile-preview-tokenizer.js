...
const re_token = /\\\;|\\\,|\\\:|\\\\|\\\{|\\\}|\\sqrt\[.*?\]|\\begin\{\w+\}|\\end\{\w+\}|(\\mathscr|\\mathcal|\\mathbf|\\mathbb|\\mathrm|\\mathit)\s*\{[A-Za-z0-9]*\}|\\[a-zA-Z]+|./g;
...
//console.log('s_=',s_);
        ...
        case '\\frac':
          ...
          if (this.isdisplaymath && this.fraclevel == 1) {
            ...
            var [w1_,h1_,mid1_,s1_,g1_,q1_,id1_] = this.shrinkSvg(this.toInnerSvg(v[1],compact),rate);
            var [w2_,h2_,mid2_,s2_,g2_,q2_,id2_] = this.shrinkSvg(this.toInnerSvg(v[2],compact),rate);
          }
          w = (w1_ > w2_) ? w1_ : w2_;
  ...
  toSvg (v,addoutline = false) {
    ...
    var v = [w,h,mid,s,g,q,id];
    var myszpt = this.getFontsizePt(this.parser.fontsize);
    var _nw = w;
    var _nh = h;
    var _nmid = mid;
    console.log('james: this.parser.fontsize=',this.parser.fontsize);
    console.log('james: this.parser.basefontsize=',this.parser.basefontsize);
    console.log('james: rate=',rate);
    if (myszpt) {
      console.log('james: myszpt=',myszpt);
      var rate = myszpt/parseFloat(this.parser.normalsize);
      console.log('james: rate=',rate);
    ...
    console.log('james w=',w);
    console.log('james h=',h);
    console.log('james mid=',mid);
    console.log('james _nw=',_nw);
    console.log('james _nh=',_nh);
    console.log('james _nmid=',_nmid);
...
C54.993,0,51.032,13.585,49.108,20.104z"/>`);
    ...
    return `\
<svg xmlns:xlink='http://www.w3.org/1999/xlink' width='${_nw}pt' height='${_nh}pt' viewBox='0 0 ${w*1.333333} ${h*1.333333}'
