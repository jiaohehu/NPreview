...
class NitrilePreviewHtml extends NitrilePreviewParser {
  ...
  /*
    ...
    */
  translateHtml (config,blocks,isarticle,isoutline,o) {
    ...
    for (var block of blocks) {
      ...
      this.block = block;
      const [id,row1,row2,sig,n,data,para,fencecmd,dept,caption,hidden,fname,plevel] = block;
      ...
      switch (sig) {
          ...
          switch (cat) {
            case 0:
              if (isarticle) {
                ...
                heading = 'CHAPTER';
                section = id;
                o.push(`<h1 id='${id}' class='CHAPTER' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
                o.push(`Chapter ${dept} &#160; ${this.escape(text)}`);
                o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
                o.push(`</h1>`);
              }
              break;
            case 1:
              heading = 'SECTION';
              section = id;
              o.push(`<h2 id='${id}' class='SECTION' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
            ...
            case 2:
              heading = 'SUBSECTION';
              section = id;
              o.push(`<h3 id='${id}' class='SUBSECTION' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push(`</h3>`);
              break;
            case 3:
              ...
              section = id;
              o.push(`<h4 id='${id}' class='SUBSUBSECTION' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push(`</h4>`);
              break;
            case 4:
              heading = 'PARAGRAPH';
              section = id;
              o.push(`<h5 id='${id}' class='PARAGRAPH' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push('<p>');
            ...
            default:
              ...
              section = id;
              o.push(`<h6 id='${id}' class='SUBPARAGRAPH' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push('<p>');
              o.push(`&#160; &#160; &#160; <b>${this.escape(text)}</b> &#160;`);
        ...
        case 'VRSE': {
          ...
          o.push(`<div id='${id}' class='${sig}' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
          o.push(`<blockquote>`);
        ...
        case 'CODE': {
          ...
          if (fencecmd.listing) {
            o.push(`<div id='${id}' class='${sig}' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
            o.push(`<figure>`);
            o.push(`<figcaption>Listing ${dept}: <small><mark>[${id}]</mark></small> ${this.unmask(caption)}</figcaption>`);
        ...
        case 'VERB': {
          ...
          var text = data;
          if (fencecmd['frame']) {
            o.push(`<div id='${id}' class='${sig}' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='border:1px solid;margin-left:${left}'>`);
            var text = text.join('\n');
        ...
        case 'PICT': {
          ...
          if (fencecmd.figure) {
            o.push(`<div id='${id}' class='${sig}' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
            o.push(`<figure>`);
            o.push(`<figcaption>Figure ${dept}: <small><mark>[${id}]</mark></small> ${this.unmask(caption)}</figcaption>`);
            for (var j in text) {
              var pp = text[j];
        ...
        case 'DESC': {
          ...
          o.push(`<div id='${id}' class='${sig}' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
          o.push('<dl>');
          var [ cat, keys, text, xn ] = data;
          const xleft = `${Math.floor(xn/step)*indentMargin}cm`;
        ...
        case 'PRIM': {
          ...
          var [lead,text] = data;
          o.push(`<div id='${id}' class='PRIM' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
          o.push('<p>');
        ...
        case 'SECO': {
          ...
          var [lead,text] = data;
          o.push(`<div id='${id}' class='SECO' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
          o.push('<p>');
          o.push(`&#160; &#160; &#160; <b>${this.escape(lead)}</b> &#160;`);
          o.push(`${this.unmask(text)}`);
          o.push('</p>');
        ...
        default: {
          ...
          o.push(`<div id='${id}' class='TEXT' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
          var text = this.unmask(data);
          o.push(`<p>${text}</p>`);
          o.push('</div>');
          o.push('');
  ...
  */
  style (type, text) {
    ...
    switch (type) {
      ...
      case 'ref': {
        return `<small><mark>\[<a href='#${text}'>${this.escape(text)}</a>\]</mark></small>`
        break;
      }
      default: {
