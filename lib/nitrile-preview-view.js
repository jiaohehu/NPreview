  ...
  async saveAs (savefilepath) {
    ...
    try {
      ...
      if (this.saveastype === 'latex') {
        ...
        var texlines = parser.translateBlocks(this.all,this.config);
        var data = parser.toContexDocument(this.config,texlines);
        ...
        var data = parser.toXhtmlDocument(this.config,htmlines,stylesheet_html);
        ...
        var htmlines = this.all.map(x=>x.html);
        var stylesheet_html = parser.stylesheet_html;
        var data = parser.toHtmlDocument(this.config,htmlines,stylesheet_html);
