    ...
    if (Array.isArray(v)) {
      switch (v[0]) {
        ...
        case '\\sqrt':  
          ...
          o.push(`</svg>`);
          o.push(`<line x1='${lead}pt' y1='0.5pt' x2='${w}pt' y2='0.5pt' class='MyLine'/>`);
          return [w,h,mid,o.join('\n')];
          break;
        ...
        case '\\frac':  
          ...
          if (w1_ < w2_) {
            ...
            o.push(s1_);
            o.push(`</svg>`);
            o.push(`<svg x='2pt' y='${2+h1_}pt'>`);
            o.push(s2_);
            o.push(`</svg>`);
            o.push(`<line x1='0pt' y1='${1+h1_}pt' x2='${w}pt' y2='${1+h1_}pt' class='MyLine'/>`);
            return [w,h,mid,o.join('\n')];
          } else {
            var dx = 2+ (w1_ - w2_)/2;
        ...
        case '\\sub':  
          ...
          var o = [];
          o.push(s1_);
          o.push(`<svg x='${w1_}pt' y='${h1_-(h2_/4.0)}' width='${w2_/2.0}' height='${h2_/2.0}' viewbox='0 0 ${w2_*1.333} ${h2_*1.333}'>`);
          o.push(s2_);
          o.push(`</svg>`);
          return [w1_+(w2_/2.0),h1_,mid1_,o.join('\n')];
          break;
