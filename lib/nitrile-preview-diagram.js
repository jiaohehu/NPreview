...
class NitrilePreviewDiagram {
  ...
  parseLine(line) {
    ...
    if ((v = this.re_label_command.exec(line)) !== null) {
      ...
      var [t,line] = this.readActionLabel(line);
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      g.anchor = opt;
      g.label = t;
      this.commands.push(this.do_text(g,coords));
    ...
    ///
    ///NOTE: dealing directly with a path
    ///
    if ((v = this.re_drawcontrolpoints_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_drawcontrolpoints(coords,g));
      this.lastcoords = coords;
      return false;
    }
    if ((v = this.re_line_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_p_path(coords,p,g));              
      this.lastcoords = coords;
      return false;
    }
    if ((v = this.re_area_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_p_path(coords,{fill:1},g));              
      this.commands.push(this.do_p_path(coords,{},g));              
      this.lastcoords = coords;
      return false;
    }
    ...
    if ((v = this.re_arrow_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_p_path(coords,{arrowend:1},g));
      this.lastcoords = coords;
      return false;
    }
    if ((v = this.re_revarrow_command.exec(line)) !== null) {
      ...
      var coords = this.readCoordsLine(line);
      var p = {arrowstart:1};
      this.commands.push(this.do_p_path(coords,{arrowstart:1},g));
      this.lastcoords = coords;
      return false;
    }
    if ((v = this.re_dblarrow_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_p_path(coords,{arrowstart:1,arrowend:1},g));
      this.lastcoords = coords;
      return false;
    }
    ...
    if ((v = this.re_dot_command.exec(line)) !== null) {
      ...
      for (var i = 0; i < coords.length    ; i++) {
        ...
        var x = z0[0];
        var y = z0[1];
        this.commands.push(this.do_p_dot(x,y,g));
      }
      this.lastcoords = coords;
      return false;
    }
    ...
    if ((v = this.re_cartesian_command.exec(line)) !== null) {
      ...
      this.commands.push(this.do_cartesian(opt,t,g,floats));
      return false;
    }
    if ((v = this.re_barchart_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var floats = this.readFloatsLine(line);
      this.commands.push(this.do_barchart(opt,t,g,floats));
      return false;
    }
    if(line.length>0){
      this.commands.push(this.do_comment(`${line}`));
  ...
  do_barchart(opt,t,g,floats) {
    ...
    var A = this.barcharts[id];
    opt = opt.slice(1);//get rid of the first dot
    var opts = opt.split('.');
    var act = opts[0];
    var subact = opts[1];
    switch( act ) {
      ...
      case 'bbox'://BARCHART
        ...
        s.push(this.do_p_path(coords,{},g));
        break;
  ...
  do_cartesian(opt,t,g,floats) {
    ...
    switch( act ) {
      ...
      case 'xaxis'://DIAGRAM
        ...
        var coords = this.readCoordsLine(mypath);
        o.push(this.do_p_path(coords,{arrowstart:1,arrowend:1},g));
        break;
      ...
      case 'line'://CARTESIAN
        ...
        o.push(this.do_p_path(coords,{},g));
        break;
      ...
      case 'arrow'://CARTESIAN
        ...
        o.push(this.do_p_path(coords,{arrowend:1},g));
        break;
      ...
      case 'arc'://CARTESIAN
        ...
        y += A.yorigin;
        r /= A.grid;
        o.push(this.do_p_arc(x,y,r,a1,a2,g));
        break;
  ...
  do_shape(coords,w,h,mypath,g){
    ...
    for (var i = 0; i < coords.length; i++) {
      ...
      var x = z0[0];
      var y = z0[1];
      o.push(this.do_p_shape(x,y,w,h,mypath,g));
    }
    return o.join('\n');
  }
