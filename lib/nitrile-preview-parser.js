  ...
  toFlow(lines,plevel,fname,o=null) {
    ...
    */
    ...
    while (lines.length > 0) {
      ...
      /// merge the fencecmd with the_caption_block
      ...
      if (block_type === 'SAMP' && block_type0 === 'PLST') {
        ...
        if (sig === 'imgs') {
          ...
          o.push([id,row,row2,'MATH','',data,para,fencecmd,star,base,label,fname]);
          ...
          o.push([id,row,row2,'VERB','',data,para,fencecmd,star,base,label,fname]);
        ...
        ///o.push([id,row,row2,data.name,'',data,para,fencecmd,'',base,label,fname]);
        ...
        if ((v=this.re_displaymath.exec(text))!==null) {
          text = v[1];
          o.push([id,row,row2,'MATH','',[[text]],para,fencecmd,'',base,label,fname]);
          block_tyep = 'MATH';
        } if ((v=this.re_hruler.exec(text))!==null) {
          text = '* * *';
          o.push([id, row, row2, 'HRLE', '', text, para, fencecmd, '', base, label, fname]);
        } else {
