...
console.log(block);
  ...
  read_para (lines) {
    ...
    if(type == 'pict'){
      ...
      return {para,lines,sig,caption,label,rows,isfenced,fenceid,body};
    } 
    else if (type == 'tabr'){
      ...
      return {para,lines,sig,label,maths};
    }
    else if(type == 'quot'){
      text = this.joinPara(body);
      return {para,lines,sig,text};
    }
    else if(type == 'plst'){
      var items = this.parse_plst(body);
      return {para,lines,sig,items};
    }
    else if(type == 'hlst'){
      ...
      return {para,lines,sig,leadn,lead,text};
    }
