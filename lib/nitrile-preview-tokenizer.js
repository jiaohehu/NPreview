        ...
        case '\\sqrt':
          ...
          if (1) {
            ...
            if(n){
              ...
              o.push(`<svg x='1pt' y='-1pt' width='${w1_}pt' height='${h1_}pt' viewBox='0 0 ${w1_ * 1.333} ${h1_ * 1.333}'>`);
              o.push(s1_);
              o.push(`</svg>`);
            }
            this.used.add('mySQRT');
            ...
            var o = [];
            /// draw the power-text
            o.push(`<svg x='1pt' y='-1pt' width='${nw1_}pt' height='${nh1_}pt' viewBox='0 0 ${w1_*1.333} ${h1_*1.333}'>`);
            o.push(s1_);
            o.push(`</svg>`);
            /// draw content-text
            o.push(`<svg x='${nlead+lead}pt'>`);
