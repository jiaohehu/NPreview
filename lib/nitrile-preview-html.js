...
`;
  ...
  do_hdgs(block) {
    ...
    if(part){
      o.push(`<h2 ${this.xhtmlattr}>Part ${dept} &#160; ${text}</h2>`);
    } else if(level==0) {
      o.push(`<h2 ${this.xhtmlattr}>${text}</h2>`);
    } else if(level==1) {
      o.push(`<h2 ${this.xhtmlattr}>${dept} &#160; ${text}</h2>`);
    } else if(level==2) {
      o.push(`<h2 ${this.xhtmlattr}>${dept} &#160; ${text}</h2>`);
    } else if(level==3) {
      o.push(`<h3 ${this.xhtmlattr}>${dept} &#160; ${text}</h3>`);
    } else {
      o.push(`<h4 ${this.xhtmlattr}>${dept} &#160; ${text}</h4>`);
    }
    o.push('');
    block.html = o.join('\n');
  }
  ...
  do_text(block) {
    ...
    ///output to 'o'
    o.push(`<p ${this.xhtmlattr}>${text}</p>`);
    o.push('');
    block.html = o.join('\n');
  }
  do_pict(block) {
  ...
  do_quot(block) {
    ...
    text = `${lq}${text}${rq}`;
    var o = [];
    o.push(`<blockquote ${this.xhtmlattr}>`);
    o.push(text);
    o.push(`</blockquote>`);
    o.push('');
    block.html = o.join('\n');
