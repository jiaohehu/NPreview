...
class NitrilePreviewContex extends NitrilePreviewParser {
  ...
  do_dlst(block){
    ...
    for (var item of items) {
      ...
      if(type=='text'){
        ...
        key = this.escape(key);
        text = this.unmask(text);
        o.push(`\\latexdesc{${bull} {\\it{}${key}}} ${text} \\par`);
      }else if(type=='code'){
        key = this.escape(key);
        text = this.unmask(text);
  ...
  do_tabr(block){
    var o = [];
    var {id,row1,row2,wide,sig,cols,subfname} = block;
    o.push(this.to_info(block));
    var s = [];
    ...
    var text = s.join('\n');
    if(wide){
      o.push(`\\startpostponing`);
      o.push(`\\placefloat`);
      o.push(`[here]`);
      o.push(`[${this.label_text}]`);//get rid of #
      o.push(`{${this.polish_caption(this.caption_text)}}`);//already unmasked
      o.push('{%');
      o.push(`\\setupTABLE[width=${1/maxj}\\makeupwidth]`);
      o.push(text);
      o.push('}');
      o.push(`\\page`);
      o.push(`\\stoppostponing`);
    } else if(this.caption_text){
      o.push(`\\placefloat`);
      o.push(`[here]`);
      o.push(`[${this.label_text}]`);//get rid of #
      o.push(`{${this.polish_caption(this.caption_text)}}`);//already unmasked
