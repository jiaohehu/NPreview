...
position: relative;`
              heading = 'CHAPTER';
              o.push(`<h1 id='${id}' class='${heading}' dept='${dept}' fName='${fname}'  subrow='${subrow}' rows='${row1} ${row2}' style='${cssstyle}' >`);
...
position: relative;`
              heading = 'SECTION';
              o.push(`<h2 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='${cssstyle}'>`);
...
position: relative;`
              heading = 'SUBSECTION';
              o.push(`<h3 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='${cssstyle}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              if (config.showlabels) {
                o.push(`<mark style='font-size:small;position:absolute; '>[${label}]</mark>`);
              }
...
position: relative;`
              ...
              o.push(`<h4 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='${cssstyle}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              if (config.showlabels) {
                o.push(`<mark style='font-size:small;position:absolute; '>[${label}]</mark>`);
              }
...
position: relative;`
              ...
              o.push(`<h5 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='${cssstyle}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              if (config.showlabels) {
                o.push(`<mark style='font-size:small;position:absolute; '>[${label}]</mark>`);
              }
...
position: relative;`
              ...
              o.push(`<h6 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='${cssstyle}'>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              if (config.showlabels) {
                o.push(`<mark style='font-size:small;position:absolute; '>[${label}]</mark>`);
              }
