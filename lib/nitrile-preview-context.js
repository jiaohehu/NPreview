...
class NitrilePreviewContext extends NitrilePreviewTranslator {
  ...
  constructor() {
    ...
    this.xconfig.section = '\\bfa';
    this.xconfig.subsection = '\\bf';
    this.xconfig.subsubsection = '\\bf';
    this.xconfig.subsubsubsection = '\\bf';
  ...
  do_part(block) {
    ...
    if(this.xconfig.partpage){
      var s=this.xconfig.part.split('\t');
