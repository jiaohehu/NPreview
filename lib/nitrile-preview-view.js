...
padding-left: ${this.config.leftmargin}cm;
padding-right: ${this.config.rightmargin}cm;
margin: 0;
font-size: 11pt;
background-color: white;`;
    ...
    if (this.blocks.length) {
      this.htmls.push(`<div class='PAGE' style='${pagestyle}' >`);
  ...
  async saveAs (savefilepath) {
    ...
    try {
      ...
      if (this.saveastype === 'latex-chapter') {
        ...
        var documentclassopts = this.config.documentclassopts;
