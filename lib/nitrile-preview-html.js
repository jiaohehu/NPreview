...
class NitrilePreviewHtml extends NitrilePreviewParser {
      ...
      switch (sig) {
        ...
        case 'HDGS': {
          ...
          switch (cat) {
            case 0:
              heading = 'CHAPTER';
              o.push(`<h1 id='${id}' class='${heading}' dept='${dept}' fName='${fname}'  subrow='${subrow}' rows='${row1} ${row2}' style='position:relative; '>`);
            ...
            case 1:
              heading = 'SECTION';
              o.push(`<h2 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='position:relative; '>`);
            ...
            case 2:
              heading = 'SUBSECTION';
              o.push(`<h3 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='position:relative; '>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              if (config.showlabels) {
                o.push(`<mark style='font-size:small;position:absolute; '>[${id}]</mark>`);
              }
            ...
            case 3:
              ...
              o.push(`<h4 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='position:relative; '>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              if (config.showlabels) {
                o.push(`<mark style='font-size:small;position:absolute; '>[${id}]</mark>`);
              }
            ...
            case 4:
              ...
              o.push(`<h5 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='position:relative; '>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              if (config.showlabels) {
                o.push(`<mark style='font-size:small;position:absolute; '>[${id}]</mark>`);
              }
            ...
            default:
              ...
              o.push(`<h6 id='${id}' class='${heading}' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='position:relative; '>`);
              o.push(`${dept} &#160; ${this.escape(text)}`);
              if (config.showlabels) {
                o.push(`<mark style='font-size:small;position:absolute; '>[${id}]</mark>`);
              }
        ...
        case 'FIGE': {
          ...
          for (var pp of text) {
            ...
            var kk = pp.map( x => {
                ...
                return `<img id='${imgid}' alt='${src}' src='${imgdata}' width='${100.0*width}%' style='vertical-align:text-bottom; width:${100.0*width}%; min-height:100px; outline:1px solid #333;' />`;
            });
            ...
            var kk = pp.map( (x,j) => {
                var [image,width,opts,src,srcs,sub] = x;
                return `<span style='font-size:small; line-height:1; box-sizing:border-box; display:inline-block; padding:6pt; width:${100.0*width}%; text-align:center; vertical-align:top; '>(${this.toSubfigNum(j)}) ${this.unmask(sub)}</span>`;
            });
        ...
        case 'PICT': {
          ...
          o = this.convertPict (o, text, config, fencecmd);
  ...
  convertPict (o, text, config, fencecmd) {
    ...
    for (var pp of text) {
      ...
      var kk = pp.map( x => {
          ...
          return `<img id='${imgid}' alt='${src}' src='${imgdata}' width='${100.0*width}%' 
                  ...
                  min-height:100px; outline:1px solid #333;' />`;
      });
