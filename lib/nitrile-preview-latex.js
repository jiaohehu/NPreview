        ...
        case 'CODE':  
          ...
          if (fig) {
            ...
            for (var k=0; k < text.length; k += increment) {
              if (k == 0) {
                o.push(`\\begin{lstlisting}[float=*,breaklines=true,postbreak=\\mbox{\\textcolor{red}{$\\hookrightarrow$}\\space},firstnumber=${k+1},${numbers_text} label=${label},caption={${this.unmask(caption)}}]`);
              } else {
                o.push(`\\begin{lstlisting}[float=*,breaklines=true,postbreak=\\mbox{\\textcolor{red}{$\\hookrightarrow$}\\space},firstnumber=${k+1},${numbers_text} caption={${this.unmask(caption)} (continue)}]`);
              }
        ...
        case 'VERB': {
          ...
          if (fig) {
            if (fencecmd.frame) {
              ...
              o.push(`\\caption{${this.unmask(caption)}}`);
              o.push(`\\label{${label}}`);
              o.push(`\\begin{Verbatim}[frame=single]`)
            ...
            o.push(`\\begin{lstlisting}[basicstyle=\\ttfamily\\footnotesize,breaklines=true,xleftmargin=${left},columns=fullflexible,escapeinside=||,breakindent=0pt,frame=single]`)
            for (var line of text) {
              o.push(line);
            }
            o.push('\\end{lstlisting}')
