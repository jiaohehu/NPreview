...
console.log('w1=',w1);
        ...
        case '\\frac':
          var reduce_rate = this.to_frac_reduce_rate();
          var m1 = this.toInnerSvg(v[1],used,compact);
          var m2 = this.toInnerSvg(v[2],used,compact);
          return this.to_frac(m1,m2,reduce_rate,1);
          break;
        ...
        case '\\sfrac':
          ...
          var o = [];
          o.push(s1_);
          o.push(`<svg x='${w-w2_}pt' y='${h-h2_}pt'>`);
          o.push(s2_);
          o.push(`</svg>`);
        ...
        case '\\binom':
          ...
          var m1 = this.toInnerSvg(v[1],used,compact);
          var m2 = this.toInnerSvg(v[2],used,compact);
          var m = this.to_frac(m1,m2,reduce_rate,0);
  ...
  to_frac(m1,m2,reduce_rate,isline){
