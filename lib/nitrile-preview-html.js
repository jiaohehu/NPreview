    ...
    for (var block of blocks) {
      ...
      switch (type) {
          ...
          switch (cat) {
            case 0:
              if (isarticle) {
                ...
                heading = 'CHAPTER';
                section = id;
                o.push(`<h1 id='${id}' class='CHAPTER' section='${section}' rows='${row1} ${row2}'>`);
            ...
            case 1:
              heading = 'SECTION';
              section = id;
              o.push(`<h2 id='${id}' class='SECTION' section='${section}' rows='${row1} ${row2}'>`);
            ...
            case 2:
              heading = 'SUBSECTION';
              section = id;
              o.push(`<h3 id='${id}' class='SUBSECTION' section='${section}' rows='${row1} ${row2}'>`);
              o.push(`${refname} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push(`</h3>`);
              break;
            case 3:
              ...
              section = id;
              o.push(`<h4 id='${id}' class='SUBSUBSECTION' section='${section}' rows='${row1} ${row2}'>`);
              o.push(`${refname} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push(`</h4>`);
              break;
            case 4:
              heading = 'PARAGRAPH';
              section = id;
              o.push(`<h5 id='${id}' class='PARAGRAPH' section='${section}' rows='${row1} ${row2}'>`);
              o.push(`${refname} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push('<p>');
            ...
            default:
              ...
              section = id;
              o.push(`<h6 id='${id}' class='SUBPARAGRAPH' section='${section}' rows='${row1} ${row2}'>`);
              o.push(`${refname} &#160; ${this.escape(text)}`);
              o.push(`<small><mark isOutline='${isoutline}' fName='${fname}' section='${id}'>[${id}]</mark></small>`);
              o.push('<p>');
              o.push(`&#160; &#160; &#160; <b>${this.escape(text)}</b> &#160;`);
        ...
        case 'VRSE': {
          ...
          o.push(`<div id='${id}' class='${type}' section='${section}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
          o.push(`<blockquote>`);
        ...
        case 'VERB': {
          ...
          var text = data;
          if (fencecmd['frame']) {
            o.push(`<div id='${id}' class='${type}' section='${section}' rows='${row1} ${row2}' style='border:1px solid;margin-left:${left}'>`);
            var text = text.join('\n');
        ...
        case 'DESC': {
          ...
          o.push(`<div id='${id}' class='${type}' section='${section}' rows='${row1} ${row2}'>`);
          o.push('<dl>');
        ...
        case 'PRIM': {
          ...
          var [lead,text] = data;
          o.push(`<div id='${id}' class='PRIM' section='${section}' rows='${row1} ${row2}'>`);
          o.push('<p>');
        ...
        case 'SECO': {
          ...
          var [lead,text] = data;
          o.push(`<div id='${id}' class='SECO' section='${section}' rows='${row1} ${row2}'>`);
          o.push('<p>');
          o.push(`&#160; &#160; &#160; <b>${this.escape(lead)}</b> &#160;`);
          o.push(`${this.unmask(text)}`);
          o.push('</p>');
        ...
        default: {
          ...
          o.push(`<div id='${id}' class='TEXT' section='${section}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
          var text = this.unmask(data);
          o.push(`<p>${text}</p>`);
          o.push('</div>');
          o.push('');
