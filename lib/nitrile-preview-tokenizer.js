...
//console.log('s_=',s_);
  ...
  toSvg (v,addoutline = false) {
    ...
    return `\
<svg xmlns:xlink='http://www.w3.org/1999/xlink' width='${nw*1.3333}' height='${nh*1.3333}' fill='currentColor' stroke='currentColor' font-size:12pt; viewBox='0 0 ${w*1.3333} ${h*1.3333+1}'
style='vertical-align:${dv}pt; font-size:12pt;' role='img' focusable='false'
