...
class NitrilePreviewDiagram {
  ...
  initSettings() {
    ...
    this.def_fill = this.fill = '';
    this.def_stroke = this.stroke = '';
    this.def_stroke_width = this.stroke_width = '';
  }
  ...
  toMetaPost (para) {
    ...
    for (line of para) {
      ...
      if ((v = this.re_set_command.exec(line)) !== null) {
        ...
        if (key === 'fill' ){ this.fill = this.toColor(val,this.def_fill); } ///such as 'red', '0.5red', or 0.8[red,green]
        if (key === 'stroke' ){ this.stroke = this.toColor(val,this.def_stroke); } ///such as 'red', '0.5red', or 0.8[red,green]
        if (key === 'stroke-width' ){ this.stroke_width = this.toLength(val,this.def_stroke_width); } ///such as '0', '0.1', '1pt', '1mm'
        continue;
      }
