      ...
      switch (sig) {
        ...
        case 'CODE':  
          ...
          if (fig) {
            ...
            o.push(`<pre style='${this.precssstyle} margin-left:auto; margin-right:auto; ' >${text}</pre>`);
            o.push(`</div>`);
            o.push('');
        ...
        case 'TABB': {
          ...
          if (fig) {
            ...
            o.push(`<table style='${this.paracssstyle} ${this.tablecssstyle} margin-left:auto; margin-right:auto; ' >`);                
            var rowcount = 0;
            for (var pp of text) {
              rowcount += 1;
              pp = pp.map(x => x.split('\n'));
