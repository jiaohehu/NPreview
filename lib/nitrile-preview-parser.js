...
class NitrilePreviewParser {
  ...
  toBlocks(lines,fname,subrow,plevel,o=null) {
    ...
    /// if it is a PART
    if (plevel < 0) {
      o.push(this.newPART(subrow,lines[0]));
      return [o,{},[]];
    }
    ...
    while (lines.length > 0) {
        ...
        if (!isNaN(m) && m > 0) {
          ...
          if (v) {
            if (v[1].length >= m) {
              ...
              o.push([id,row,row2,'SMPL',0,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
      ...
      if (the_fence === '~~~' ) {
        ...
        o.push([id,row,row2,brand,n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (the_fence === '```' ) {
        ...
        o.push([id,row,row2,'CODE',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (the_fence === '---') {
        ...
        o.push([id,row,row2,'VRSE',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue
      }
      ...
      if (the_fence === '///') {
        ...
        o.push([id,row,row2,'PICT',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (the_fence === '===') {
        ...
        o.push([id,row,row2,'TABB',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (the_fence === '<<<') {
        ...
        o.push([id,row,row2,'TERM',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (the_fence === '\"\"\"') {
        ...
        o.push([id,row,row2,'QUOT',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (the_fence === '\$\$\$') {
        ...
        o.push([id,row,row2,'EQTN',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (this.re_hyphen_hyphen.test(para[0])) {
        ...
        o.push([id,row,row2,'DESC',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        o.push([id,row,row2,'PRIM',0,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        o.push([id,row,row2,'SECO',0,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (v) {
        ...
        o.push([id,row,row2,'PLST',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue
      }
      ...
      if ((v = this.re_hdgs.exec(para[0])) !== null) {
        ...
        o.push([id,row,row2,'HDGS',0,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (true) {
        ...
        o.push([id,row,row2,'',n,data,para,fencecmd,dept,fig,caption,base,label,fname,subrow,plevel]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
  ...
  async fetchBookBlocks(lines,dirname) {
    ...
    for (var myOpener of myOpeners) {
      ...
      if (sublevel < 0) {
        ...
        myBlocks.push(subparser.newPART(subrow,subpart));
        continue;
      }
      try {
  ...
  newPART (subrow,subpart) {
    ...
    var plevel = 0;
    var label = '';
    return [id,-1,-1,'PART',0,subpart,[],fencecmd,dept,fig,caption,base,label,fname,subrow,plevel];

  }

  newFILE (fname,subrow,plevel) {
    ...
    var base = '';
    var label = '';
    return [id,-1,-1,'FILE',0,[],[],fencecmd,dept,fig,caption,base,label,fname,subrow,plevel];

  }

  newFEND (fname,subrow,plevel) {
    ...
    var base = '';
    var label = '';
    return [id,-1,-1,'FEND',0,[],[],fencecmd,dept,fig,caption,base,label,fname,subrow,plevel];

  }

  newHDGS (str,fname,subrow,plevel) {
    ...
    var base = '';
    var label = '';
    return ['',-1,-1,'HDGS',0,[0,str],[],fencecmd,dept,fig,caption,base,label,fname,subrow,plevel];
  ...
  idenXrefs (config,blocks,isarticle) {
    ...
    /// return an object with mappings from label -> dept that 
    ...
    for (var block of blocks) {
      ...
      if (label) {
        if (sig === 'HDGS') {
          if (xrefs[label]) xrefs[label].push( `${dept}` );
          else xrefs[label] = [dept];
        } else if (fig ) {
          if (xrefs[label]) xrefs[label].push( `${fig}` );
          else xrefs[label] = [fig];
        }
      }
    }
    return xrefs;
  ...
  idenSubs (config,subs) {
    var o = [];
    for (var sub of subs) {
      let [subblocks] = sub.flow;    
      for (subblock of subblocks) {
        o.push(subblock);
      }
    }
    return this.idenBlocks(config,o,false);
  }
...
console.error('rubify');
console.error(this.rubymap);
    ...
    while (j < src.length) {
      ...
      for (var rubyitem of this.rubymap) {
        ...
        if (i < i0) { /// first found or a new found that is closer
          ...
          found_str1 = str1;
          found_str2 = str2;
        } else if (str1.length > found_str1.length) { /// found at the same location, choose the one that is the longest
          i0 = i;
          found = 1;
          found_str1 = str1;
          found_str2 = str2;
  ...
  buildRubyMap (json) {
    ...
    for (var item of json.v5m) {
      ...
      /// 包んだ    つつんだ
      o.push(item);
      o.push([`${base.slice(0,base.length-1)}\u307e`,`${top.slice(0,top.length-1)}\u307e`]);
      o.push([`${base.slice(0,base.length-1)}\u307f`,`${top.slice(0,top.length-1)}\u307f`]);
      o.push([`${base.slice(0,base.length-1)}\u3081`,`${top.slice(0,top.length-1)}\u3081`]);
      o.push([`${base.slice(0,base.length-1)}\u3082\u3046`,`${top.slice(0,top.length-1)}\u3082\u3046`]);
      o.push([`${base.slice(0,base.length-1)}\u3093\u3067`,`${top.slice(0,top.length-1)}\u3093\u3067`]);
      o.push([`${base.slice(0,base.length-1)}\u3093\u3060`,`${top.slice(0,top.length-1)}\u3093\u3060`]);
    }
