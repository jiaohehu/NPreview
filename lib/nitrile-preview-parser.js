...
console.log('james: readPara returned: para=',para);
  ...
  readPara (lines) {
console.log('james: readPara: lines=',lines);
...
console.log('james, is_fence=',is_fence);                 
console.log('james, the_fence=',the_fence);                 
      var line = lines[i];
      line = line.trimRight();
      if (is_fence) {
        if ((v = this.re_fence.exec(line)) !== null && v[1] == the_fence) {
console.log('james, encountered the end of fence, v=',v);
          para.push(line);
          i += 1;
          break
        }
      ...
      if (num_solid === 1) {
console.log('james: line=',line);
console.log('james: num_solid=',num_solid);
...
console.log('james: is_sample=',is_sample);
console.log('james: the_sample_fence=',the_sample_fence);
            continue
          }
        }
