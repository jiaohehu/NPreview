...
class NitrilePreviewParser {
  ...
  addBuiltinRubymap(rmap) {
    var types = ['number','date','vsuru','v1','v5m','v5b','v5n','v5s','v5g','v5k','v5r','v5t','v5u','adji','exp'];
