        ...
        case 'oldmath': {
          ...
          if (!fencecmd.label) {
            if (fencecmd.alignequalsign) {
              ...
              var v = null;
              o.push(`\\[`);
              o.push(`\\begin{array}{rcl}`);
              for (var s of text) {
                if ((v = re_equalsign.exec(s)) !== null) {
                  o.push(`\\displaystyle ${v[1]} & = & \\displaystyle ${v[2]}`);
                  o.push('\\\\');
                  o.push('\\noalign{\\medskip}');
                } else {
                  o.push(`& & \\displaystyle ${s}`);
                  o.push('\\\\');
                  o.push('\\noalign{\\medskip}');
                }
              }
              o.pop(); /// pop 2 times, noalign and the double-backslash
              o.pop();
              o.push(`\\end{array}`);
              o.push(`\\]`);
              o.push('');
