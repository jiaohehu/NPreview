    ...
    for (var block of all) {
      ...
      switch (sig) {
        ...
        case 'SAMP': {
          ...
          text = text.join('\n');
          o.push(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${this.xleft};font-size:${this.xsize};'>`);
          o.push(`<pre>${text}</pre>`);
          o.push(`</p>`);
          o.push('');
        ...
        case 'TEXT': {
          ...
          if ((v=this.re_displaymath.exec(text))!==null) {
            ...
            o.push(`<p id='${id}' class='P MATH' style='text-align:center' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' >`);
            o.push(`${text}`);
            o.push('</p>');
        ...
        case 'quot': {
          ...
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style=''>`);
          for (var p of text) {
        ...
        case 'DIAG': {
          if (star) {
            ...
            o.push(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style=''>`);
        ...
        case 'LSTG': {
          ...
          o.push(`<div id='${id}' class='DIV ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='font-size:${this.xsize}'>`);
          o.push(`<p class='P'>`);
...
///~~~
  ...
  toMultline(o,id,sig,dept,fname,row1,row2,data,fencecmd,isalignequalsign) {
    ...
    o.push(`<table id='${id}' class='P ${sig}' border='0' style='margin-left:auto;margin-right:auto;' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='' >`);
    var bls = data;
    var j = 0;
    var idnum = fencecmd.idnum;
    var idnum = idnum || '';
