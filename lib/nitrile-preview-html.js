...
`;
  ...
  do_part(block) {
    var {id,row1,row2,sig,dept,data,para,dept,fencecmd,base,subrow,fname} = block;
    var text = data;
  ...
  do_verb(block) {
    ...
    if (this.xname === 'listing') {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;' >`);
      o.push(`<figcaption> Listing ${this.xidnum} : ${this.caption_text} </figcaption>`);
      o.push(text);
      o.push('</figure>');
      o.push('');
    } else {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' >`);
      o.push(text);
      o.push(`</figure>`);
      o.push('');
    }
  ...
  do_item(block) {
    ...
    var text = data;
    text = this.unmask(text);
    o.push(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${fencecmd.left}mm;'>${text}</p>`);
    o.push('');
    block.html = o.join('\n');
  }
  ...
  do_list(block) {
    ...
    text = text.join('\n');
    o.push(`<ul id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='list-style-position:inside;margin-left:${this.xleft};'>${text}</ul>`);
    o.push('');
    block.html = o.join('\n');
  } 
  do_samp(block) {
    ...
    if (this.xsamptype === 0) {
      ...
      text = text.join('\n');
      o.push(`<pre id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${fencecmd.left}mm;font-size:${fencecmd.cssfontsize};'>${text}</pre>`);
      o.push('');
      ...
      if (fencecmd.autoruby) { text = text.map( x => this.rubify(x) ); }
      text = text.join('<br/>\n');
      o.push(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${fencecmd.left}mm;font-size:${fencecmd.cssfontsize};'>${text}</p>`);
      o.push('');
      ...
      text = text.join('\n');
      o.push(`<ul id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${fencecmd.left}mm;font-size:${fencecmd.cssfontsize};padding-left:0;list-style-position:outside;' >${text}</ul>`);
      o.push('');
  ...
  do_text(block) {
    var {id,row1,row2,sig,lead,leadn,data,para,dept,fencecmd,base,subrow,fname} = block;
    var o = []; 
    var text = data;
    var v;
    if (leadn && leadn>0) {
      ...
      o.push(`<p id='${id}' class='P TEXT' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-bottom:0;text-indent:0; ' >`);
      o.push(text);
      o.push('</p>');
    }
      ...
      text = this.unmask(text);
      o.push(`<p id='${id}' class='P TEXT' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='margin-top:0;margin-bottom:0;text-indent:${fencecmd.csstextindent}mm; ' >`);
      o.push(text);
      o.push('</p>');
    } 
    o.push('');
  ...
  do_quot(block) {
    ...
    o.push(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='font-size:${fencecmd.cssfontsize};margin-left:${fencecmd.left}mm;margin-right:${fencecmd.right}mm;'>`);
    o.push(`${lq}${text}${rq}`);
    o.push(`</p>`);
    o.push('');
    block.html = o.join('\n');
  ...
  do_imgs(block) {
    ...
    s.unshift(`<p id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' >`);
    s.push('</p>');
...
<p style='text-align:center'> ${this.escape(new Date().toLocaleDateString())} </p>
${htmlines.join('\n')}
</main>
</body>
</html>
