    ...
    switch (schema['type']) {
      ...
      case 'integer': {
        ...
        if (schema.hasOwnProperty('minimum')) {
          var the_minimum = parseInt(schema['minimum']);
          if (val < the_minimum) {
            val = the_minimum;
          }
          var the_maximum = parseInt(schema['maximum']);
          if (val > the_maximum) {
            val = the_maximum;
          }
        }
      ...
      case 'number': {
        ...
        if (schema.hasOwnProperty('minimum')) {
          var the_minimum = parseFloat(schema['minimum']);
          if (val < the_minimum) {
            val = the_minimum;
          }
          var the_maximum = parseFloat(schema['maximum']);
          if (val > the_maximum) {
            val = the_maximum;
          }
        }
