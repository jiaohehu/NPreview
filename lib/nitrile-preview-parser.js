  ...
  toBLOCKS(lines,fname,plevel,o) {
    ...
    while (lines.length > 0) {
      ...
      if (para[0] === '%!BOOK') {
        ...
        o.push([id,row,row2,'%!BOOK',0,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '---') {
        ...
        o.push([id,row,row2,'VRSE',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue
      }
      ...
      if (the_fence === '~~~') {
        var [data, n] = this.trimPara(para);
        var data = this.trimFences(data);
        o.push([id,row,row2,'VERB',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '///') {
        ...
        o.push([id,row,row2,'PICT',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '===') {
        ...
        o.push([id,row,row2,'TABB',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '<<<') {
        ...
        o.push([id,row,row2,'TERM',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (the_fence === '\"\"\"') {
        ...
        o.push([id,row,row2,'QUOT',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (re.test(para[0])) {
        ...
        o.push([id,row,row2,'DEF1',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (re.test(para[0])) {
        var data = this.parseDEF(para,re);
        o.push([id,row,row2,'DEF2',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (re.test(para[0])) {
        var data = this.parseDEF(para,re);
        o.push([id,row,row2,'DEF3',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        o.push([id,row,row2,'PRIM',0,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        o.push([id,row,row2,'SECO',0,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        o.push([id,row,row2,'PLST',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue
      }
      ...
      if ((v = re.exec(para[0])) !== null) {
        ...
        o.push([id,row,row2,'HDGS',0,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
      ...
      if (true) {
        var [data, n] = this.trimPara(para);
        var data = this.joinPara(data);
        o.push([id,row,row2,'',n,data,para,inst,inst_local,inst_t,fname,plevel]);
        continue;
      }
  ...
  */
  findIdForFname (fn, blocks) {
    for (var block of blocks) {
      const [id,row1,row2,type,n,data,para,inst,inst_local,inst_t,fname,plevel] = block;
      if (fname === fn) {
        if (type === 'HDGS') {
          if (data[0] === 0) {
            return id;
