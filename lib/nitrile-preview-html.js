    ...
    for (var block of all) {
      ...
      switch (sig) {
        ...
        case 'TBLR':  
          ...
          var s = [];
          if (sig==='TBLR') {
            s.push(`<table id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' border='0' style='font-size:${this.xsize};margin-left:auto;margin-right:auto; ' >`);
          } else if (sig==='LONG') {
            s.push(`<table id='${id}' class='P ${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' border='0' style='font-size:${this.xsize};width:100%; ' >`);
          }
