...
`;
  ...
  do_text(block) {
    ...
    if (standalone) {
      ...
      o.push(`<p id='${id}' class='P TEXT' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-top:0;margin-bottom:0;text-indent:0; ' >`);
      o.push(text);
      o.push('</p>');
    }
    else if (this.textblockcount == 1) {
      text = this.unmask(text);
      o.push(`<p id='${id}' class='P TEXT' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-top:0;margin-bottom:0;text-indent:0; ' >`);
      o.push(text);
      o.push('</p>');
      ...
      text = this.unmask(text);
      o.push(`<p id='${id}' class='P TEXT' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-top:0;margin-bottom:0;text-indent:${fencecmd.csstextindent}mm; ' >`);
      o.push(text);
      o.push('</p>');
    } 
    o.push('');
