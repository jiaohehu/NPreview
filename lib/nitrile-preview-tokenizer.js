    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
          ...
          for (let result of results) {
            ...
            if(cmdname == '\\math' && id_ == 'myAMPERSAND'){
              ...
              if(i>0){
                ...
                this.shiftdist += (this.extra_gap) * this.fs/12;
              }
              continue;
            }
            if (w_ == 0) {
        ...
        case '\\sqrt':
          ...
          var n = v[1];
          /// \sqrt{x} or \sqrt[4]{x}
          var [idr_, wr_] = this.findIdByElement('\\sqrt');//wrad_ contains the width of the radical symbol
