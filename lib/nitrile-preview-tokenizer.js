...
console.log('w1=',w1);
        ...
        case '\\sfrac':
          var [w1_,h1_,mid1_,s1_,g1_,q1_,id1_] = this.shrink_svg(this.toInnerSvg(v[1],used,compact),this.frac_rate);
          var [w2_,h2_,mid2_,s2_,g2_,q2_,id2_] = this.shrink_svg(this.toInnerSvg(v[2],used,compact),this.frac_rate);
          var w3_ = this.fs/2;
          var h3_ = this.fs;
          var w = w1_ + w3_ + w2_;
