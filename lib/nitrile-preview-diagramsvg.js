...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  drawtext(x,y,label,justi) {
    ...
    if ((v=this.re_inlinemath.exec(label))!==null) {
      ...
      h+=1;///EXPERIMENTAL: on iBook some bottom part of the letter is cut off,
      ...
      s.push(`<svg x='${x}' y='${y}' width='${w}' height='${h}' fill='inherit' stroke='inherit' viewBox='0 0 ${vw} ${vh}'>${defs_}${s_}</svg>`);
    } else {
