...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  initInternals(){
    ...
    this.barcharts = {};
    /// all funcs defined by 'def' command
    this.my_funcs = {};
  ...
  readFloatsLine(line) {
    ...
    while(line.length) {
      if(line.charCodeAt(0)==40){
        line = line.slice(1);
        var [v,line] = this.extract_next_expr(line);
      }else{
  ...
  parse_line(line,notes) {
    ...
    if ((v = this.re_label_command.exec(line)) !== null) {
      ...
      this.commands.push(this.do_text(opt,txt,g,coords));///own method
    ...
    if ((v = this.re_shape_command.exec(line)) !== null) {
      ...
      if(mypath){
        this.commands.push(this.do_shape(coords,1,1,mypath,g));///own method
        this.lastcoords = coords;
      }
      return false;
    }
    ...
    if ((v = this.re_drawcontrolpoints_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_drawcontrolpoints(opt,txt,g,coords));//not own method
      this.lastcoords = coords;
      return false;
    }
    if ((v = this.re_drawanglearc_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_drawanglearc(opt,txt,g,coords));//own method
      this.lastcoords = coords;
      return false;
    }
    ...
    if ((v = this.re_circle_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_circle(opt,txt,g,coords));///not own method
      this.lastcoords = coords;
      return false;
    }
    ///
    ...
    if ((v = this.re_box_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var coords = this.readCoordsLine(line);
      this.commands.push(this.do_box(opt,txt,g,coords));///not own method
      this.lastcoords = coords;
      return false;
    }
    ///
    ...
    if ((v = this.re_cartesian_command.exec(line)) !== null) {
      ...
      this.commands.push(this.do_cartesian(opt,txt,g,floats));///own method
      return false;
    }
    if ((v = this.re_barchart_command.exec(line)) !== null) {
      ...
      var [g,line] = this.readActionStyle(line);
      var floats = this.readFloatsLine(line);
      this.commands.push(this.do_barchart(opt,txt,g,floats));///own method
      return false;
    }
    if(line.length>0){
      this.commands.push(this.do_comment(`${line}`));
  ...
  do_cartesian(opt,txt,g,floats) {
    ...
    switch( cmd ) {
      ...
      case 'yplot'://CARTESIAN
        ...
        var n = this.assertInt(floats[2],10,1,this.MAX);
