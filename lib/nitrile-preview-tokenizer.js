...
//console.log('s_=',s_);
        ...
        case '\\od':
          ...
          if (this.isdisplaymath && this.fraclevel == 1) {
            ...
            var [w1_,h1_,mid1_,s1_,g1_,q1_,id1_] = this.shrinkSvg(this.toInnerSvg(v[2],compact),rate);
            var [w2_,h2_,mid2_,s2_,g2_,q2_,id2_] = this.shrinkSvg(this.toInnerSvg(v[3],compact),rate);
          }
          var top_w_ = wd_ + 1 + w1_;
          var bot_w_ = wd_ + 0 + w2_;
          ...
          if (top_w_ < bot_w_) {
            if (1) {
              ...
              dx += (bot_w_ - top_w_)/2;
              var dy_for_d = mid1_-6;
              o.push(`<use x='${dx}pt' y='${dy_for_d}' xlink:href='#${idd_}'/>`);
              dx += wd_;
              dx += 1;
              o.push(`<svg x='${dx}pt' y='0'>`);
              o.push(s1_);
            ...
            if (1) {
              var dx = 2;
              var dy = 1+h1_;
              var dy_for_d = mid2_-6;
              o.push(`<use x='${dx}pt' y='${dy+dy_for_d}pt' xlink:href='#${idd_}'/>`);
              dx += wd_;
              o.push(`<svg x='${dx}pt' y='${dy}pt'>`);
              o.push(s2_);
              o.push(`</svg>`);
            }
  ...
  toSvg (v,addoutline = false) {
    ...
    var rate = this.toRateFontsize(this.parser.fs);///this.parser.fs= 'normalfont', 'small', 'fontnotesize', etc.
    var nw = w;
    var nh = h;
    var nmid = mid;
...
C54.993,0,51.032,13.585,49.108,20.104z"/>`);
    ...
    return `\
<svg xmlns:xlink='http://www.w3.org/1999/xlink' width='${nw*1.3333}' height='${nh*1.3333}' viewBox='0 0 ${w*1.3333} ${h*1.3333+1}'
