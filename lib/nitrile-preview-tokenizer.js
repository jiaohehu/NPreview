...
const my_upqu_id = 'myUDQU';
const my_upqu_width = 6;
...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  buildup_defs(used){
    ...
    for (var mathSymbol of pjson.mathSymbols) {
      ...
      if (used.has(id)) {
        defs.push(`<text id='${id}' dy='${this.dy}em' textLength='${width}pt' lengthAdjust='spacingAndGlyphs' style='stroke:none;fill:inherit;font-size:${this.fs}pt;font-style:${fontstyle};'>${unicode}</text>`);
      }
    }
