...
//console.log(data);
        ...
        case 'CENTER': {
          ...
          o.push(`${showidtext}`);
          var text = this.unmask(data);
          o.push(`<p style='${this.samplecssstyle}; text-align:center; margin:0; ' >`);
          o.push(text);
          o.push(`</p>`);
          o.push('</div>');
          o.push('');
        ...
        case '': {
          ...
          text = this.unmask(text);
          o.push(`<div id='${id}' class='TEXT' dept='${dept}' fName='${fname}' subrow='${subrow}' rows='${row1} ${row2}' style='${this.divcssstyle}; margin-left:${left}cm; margin-top:0; margin-bottom:0;'>`);
          o.push(`${showidtext}`);
          o.push(`<p style='${this.paracssstyle}' >`);
