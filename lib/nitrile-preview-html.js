...
`;
      ...
      if (item.length === 3) {
        switch (lead) {
          case 'OL': {
            if(count==0){
              count++;
              o.push(`<ol ${TOPATTRS} style='${TOPSTYLE};padding-left:${fencecmd.csspaddingleft}mm;list-style-position:outside;'><li value='${value}'>${text}`);
            }else{
          ...
          case 'UL': {
            if(count==0){
              count++;
              o.push(`<ul ${TOPATTRS} style='${TOPSTYLE};padding-left:${fencecmd.csspaddingleft}mm;list-style-position:outside;'><li value='${value}'>${text}`);
            }else{
  ...
  do_samp(block) {
    ...
    if (!mode) {
      ...
      text = text.join('<br/>');
      text = `<li>${text}</li>`; 
      o.push(`<ul id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:${fencecmd.left}mm;margin-top:${this.xtop};margin-bottom:${this.xbot};font-size:${fencecmd.cssfontsize};padding-left:${fencecmd.csspaddingleft}mm;list-style-position:outside;' >${text}</ul>`);
      o.push('');
    }
    block.html = o.join('\n');
  }
  do_hrle(block) {
    ...
    var o = []; 
    var text = data;
    o.push(`<p id='${id}' class='P ${sig}' style='height:3em;display:flex;flex-direction:row;' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-top:${this.xtop};margin-bottom:${this.xbot};' >`);
    text = this.unmask(text);
  ...
  do_imgs(block) {
    ...
    if (this.xname === 'figure') {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};'>`);
      o.push(`<figcaption style='text-align:left;' > Figure ${this.xidnum} : ${this.caption_text} </figcaption>`);
      o.push(s.join('\n'));
      o.push('</figure>');
    } else {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};'>`);
  ...
  do_tblr_long(block){
    ...
    var text = s.join('\n');
    if (sig==='TBLR') {
      text = `<table border='0' style='font-size:${this.xcssfontsize};margin-left:0;margin-right:auto;border-collapse:collapse;'>${text}</table>`;
    } else if (sig==='LONG') {
      text = `<table border='0' style='font-size:${this.xcssfontsize};width:100%;border-collapse:collapse;'>${text}</table>`;
    }
    if (this.xname === 'table') {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};' >`);
      o.push(`<figcaption style='text-align:left;' > Table ${this.xidnum} : ${this.caption_text} </figcaption>`);
      o.push(text);
      o.push(`</figure>`);
    } else {
      o.push(`<figure id='${id}' class='P ${sig}' dept='${dept}' fName='${this.tofName()}' rows='${row1} ${row2}' style='margin-left:0;margin-right:0;margin-top:${this.xtop};margin-bottom:${this.xbot};' >`);
  ...
  do_diag(block){
    ...
    if (fencecmd.star) {
      ...
      var s = [];
      s.push(`<svg xmlns:xlink='http://www.w3.org/1999/xlink' fill='currentColor' stroke='currentColor' viewBox='0 0 ${vw} ${vh}'\
  ...
  displaymath (str) {
    ...
    if(this.tokenizer.isdisplaymath&&this.xsig==='TEXT'){
      return `<span style='display:inline-block;width:100%;text-align:left;margin-left:${this.xfencecmd.left}mm;margin-top:${this.xtop};margin-bottom:${this.xbot};'>${s}</span>`;
    }else{
      return s;
    }
  }
