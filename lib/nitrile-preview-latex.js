      ...
      switch (sig) {
        ...
        case 'VERB': {
          ...
          if (fig) {
            ...
            o.push(`\\begin{lstlisting}[basicstyle=\\ttfamily\\footnotesize,breaklines=true,postbreak=\\textrightarrow\\space,xleftmargin=${left}cm,columns=fullflexible,breakindent=6pt]`)
            for (var line of text) {
              o.push(line);
            }
            o.push('\\end{lstlisting}')
