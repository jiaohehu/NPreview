...
class NitrilePreviewFramedSVG extends NitrilePreviewBase {
  ...
  to_framed(ss,style){
    ...
    if (style && style.width) {
      ...
      var text = `<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' fill='currentColor' stroke='currentColor' width='${vw}' height='${vh}' style='${bs}; ' >${s}</svg>`;
    }
    s = text;
    return { s };
  }
