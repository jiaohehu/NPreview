...
class NitrilePreviewParser {
  ...
  constructor(name) {
    ...
    */
    ...
    this.xblock = null;///the active block
    this.xparser = null;///the active parser
    this.mode = [];
    this.rmap = [];
  ...
  read_para (lines,n) {
    ...
    if(type == 'spcl'){
      if(fenceid == 'framed'){
        ...
        return {para,sig,wide,caption,label,islabeled,body};
      } 
        ...
        return {para,sig,wide,caption,label,islabeled,opts,images,body};
      }
...
*/
  ...
  translateBlocks() {
    ...
    for (var block of this.blocks) {
      ...
      this.xblock = block;//the current block
      this.xparser = parser;//the parser associated with this block
