    ...
    */
    ...
    while (lines.length > 0) {
      ...
      if (block_type === 'SAMP') {
        ...
        sig = 'SAMP';
        o.push({row1,row2,sig,html,data,para,fencecmd,subrow});
        continue;
        ...
        if (v2) {
          ...
          sig = 'HDGS';
          var level = hdgn;
          o.push({row1,row2,sig,html,hdgn,level,data,para,fencecmd,subrow});
          continue;
        }
        ...
        if (sig === 'includes') {
          ...
          sig = 'FRMD';
          o.push({row1, row2, sig, html, data, para, fencecmd,  subrow, fname});
          block_type = 'FRMD';
        ...
        var data = text;
        sig = 'TEXT';
        o.push({row1,row2,sig,html,lead,leadn,data,para,fencecmd,subrow});
        block_type = 'TEXT';
