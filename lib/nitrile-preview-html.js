...
`;
  ...
  do_hdgs(block) {
    ...
    if(part){
      ...
      o.push(`<h1 ${this.toATTR(block)} style='${this.xstyle}'>Part ${dept} &#160; ${text}</h1>`);
    } else if(hdgn==0) {
      if(this.isepub){
      }else{
        o.push(`<h1 ${this.toATTR(block)} style='${this.xstyle}'>${text}</h1>`);
      }
    } else if(hdgn==1) {
      o.push(`<h2 ${this.toATTR(block)} style='${this.xstyle}'>${dept} &#160; ${text}</h2>`);
    } else if(hdgn==2) {
      o.push(`<h3 ${this.toATTR(block)} style='${this.xstyle}'>${dept} &#160; ${text}</h3>`);
    } else if(hdgn==3) {
      o.push(`<h4 ${this.toATTR(block)} style='${this.xstyle}'>${dept} &#160; ${text}</h4>`);
    } else {
      o.push(`<h4 ${this.toATTR(block)} style='${this.xstyle}'>${dept} &#160; ${text}</h4>`);
    }
    o.push('');
  ...
  do_dlst(block) {
    ...
    var o = []; 
    o.push(`<dl ${this.toATTR(block)} style='${this.xstyle}'>`);
  ...
  do_verb(block) {
    ...
    o.push(`<figure ${this.toATTR(block)} style='${this.xstyle}'>`);
    if(this.floatname){
  ...
  do_text(block) {
    ...
    ///output to 'o'
    o.push(`<p ${this.toATTR(block)} style='${this.xstyle}'>${text}</p>`);
    o.push('');
    block.html = o.join('\n');
  }
  do_pict(block) {
