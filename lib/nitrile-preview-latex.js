...
///console.log(data);
        ...
        case 'CODE': {
          const numbers = 'left';
          const xleft = N_lstlisting_numbers_xleftmargin;
          const myopts=`basicstyle=\\ttfamily\\small,numberstyle=\\tiny,breaklines=true,postbreak=\\textrightarrow\\space,numbers=${numbers},numbersep=1pt,xleftmargin=12pt`;
          var text = data;
        ...
        case '': {
          var [lead1,lead2,text,is_sample] = data;
          if (is_sample) {
            ...
            lead1 = this.unmask(lead1);
            lead2 = this.unmask(lead2);
            text = this.unmask(text);
            if (lead1) {
              o.push(`\\paragraph{${lead1}}`);
              o.push(text);
            } else if (lead2) {
              o.push(`\\subparagraph{${lead2}}`);
              o.push(text);
            } else {
              o.push(text);
            }
