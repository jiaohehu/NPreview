          ...
          switch (cat) {
            case 0:
              if (isarticle) {
                ...
                o.push(`<h1 id='${id}' class='${type}' rows='${row1} ${row2}'>`);
              ...
              break;
            case 1:
              o.push(`<h2 id='${id}' class='${type}' rows='${row1} ${row2}'>`);
              o.push(`${ins_local} &#160; ${this.escape(text)}`);
              o.push(`<small><mark>[${id}]</mark></small>`);
              o.push(`</h2>`);
              break;
            case 2:
              o.push(`<h3 id='${id}' class='${type}' rows='${row1} ${row2}'>`);
              o.push(`${ins_local} &#160; ${this.escape(text)}`);
              o.push(`<small><mark>[${id}]</mark></small>`);
              o.push(`</h3>`);
              break;
            default:
              o.push(`<h4 id='${id}' class='${type}' rows='${row1} ${row2}'>`);
              o.push(`${ins_local} &#160; ${this.escape(text)}`);
              o.push(`<small><mark>[${id}]</mark></small>`);
              o.push(`</h4>`);
              break;
        ...
        case 'PLST': {
          ...
          for (var item of data) {
            ...
            if (item.length === 3) {
              switch (lead) {
                case 'OL': {
                  o.push(`<ol style='padding-left:0.85cm;list-style-position:outside'><li value='${bullet}'>${text}`);
                  break;
                }
                case 'UL': {
                  o.push(`<ul style='padding-left:0.85cm;list-style-position:outside'><li value='${bullet}'>${text}`);
                  break;
                }
                case 'LI': {
