    ...
    if (!v) {
      ...
      switch (v[0]) {
        ...
        case '\\nroot':  
          ...
          mid = h/2;
          var o = [];
          o.push(`<svg x='${w1_+lead}pt'>`);
          o.push(s_);
          o.push(`</svg>`);
          o.push(`<svg x='${w1_}pt' y='0' width='${lead}pt' height='${h}pt' viewbox='0 0 10.666 16' preserveaspectratio='none'>`);
          o.push(`<use x='0' y='0' xlink:href='#mySQ' />`);
          o.push(`</svg>`);
          o.push(`<line x1='${w1_+lead}pt' y1='0.8pt' x2='${w1_+lead+w}pt' y2='0.8pt' class='MyLine'/>`);
          this.used.add('mySQ');
          return [w1_+lead+w,h,mid,o.join('\n')];
          break;
        ...
        case '\\subsup':  
          ...
          o.push(s3_);
          o.push(`</svg>`);
          return [w1_+this.max(nw2_,nw3_),h1_+(nh2_*0.25),mid1_,o.join('\n')];
          break;
