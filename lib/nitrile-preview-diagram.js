...
class NitrilePreviewDiagram {
  ...
  constructor (parser) {
    ...
    var shape = [];
    shape.push(['fill', '0.5white', [0,0.2], [1,0.2], [1,0.8], [0,0.8], []]);
    shape.push(['draw', '', [0,0.2], [1,0.2], [1,0.8], [0,0.8], []]);
...
console.log('text0 and text are the same');

                } else {
console.log('text0 and text are NOT the same');
