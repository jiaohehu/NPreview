...
`
  ...
  translateHtml (all,config,ispreview=false,editorrow=-1,editorcolumn=-1) {
    ...
    for (var block of all) {
      ...
      this.sig = sig;
      console.log('james: this.sig=',this.sig);
      console.log('james: this.fs=',this.fs);
      console.log('james: this.xsize=',this.xsize);
      ...
      switch (sig) {
        ...
        case 'VERB': {
          ...
          text = text.join('\n');
          o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; margin-left:${xleft}cm; font-size:${this.xsize};'>`);
...
//console.log(data);
        ...
        case 'diagram': {
          if (star) {
            ...
            o.push(`<div id='${id}' class='${sig}' dept='${dept}' fName='${fname}' rows='${row1} ${row2}' style='${this.divcssstyle}; '>`);
            o.push(`<p style='${this.paracssstyle}; text-align:left; margin:0; line-height:1; ' >`);
