...
class NitrilePreviewMemor extends NitrilePreviewParser {
  ...
  do_dlst(block){
    ...
    o.push(this.to_info(block));
    o.push(`\\begin{flushleft}`);
    o.push(`\\begin{description}[nosep,style=unboxed]`);
...
module.exports = { NitrilePreviewMemor };
