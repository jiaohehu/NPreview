      ...
      switch (type) {
        ...
        case 'PICT': {
          ...
          if (fencecmd.figure) {
            ...
            o.push('\\centering');
            o.push(`\\label{${this.toSid(id,fencecmd.label)}}`);
            for (var pp of text) {
        ...
        case 'SPEC': {
          var [text,fencecmd] = data;
          var ll = this.expandRow([],2,'L');
          if (fencecmd.adjust) {
            var ww = this.toList(fencecmd.adjust);
            var ll = this.toXtabularAligns(ll,ww);
          } else {
            var ww = this.toList('0.2 0.8');
            var ll = this.toXtabularAligns(ll,ww);
          }
          o.push(`\\begin{flushleft}`);
          o.push(`\\begin{adjustwidth}{${left}}{}`);
        ...
        case 'CODE': {
          ...
          if (fencecmd.listing) {
            ...
            o.push(`\\begin{lstlisting}[label=${sid},caption=${this.unmask(caption)}]`);
            this.lstnum += 1;
