  ...
  toFlow(lines,plevel,fname,o=null) {
    ...
    while (lines.length > 0) {
      ...
      if (is_sample && !listitemflag) {
        ...
        o.push([id,row,row2,'SAMP',0,data,para,fencecmd,caption,base,label,fname]);
      ...
      if (is_sample && listitemflag) {
        ...
        data = [fence,data];
        o.push([id,row,row2,'ITEM',0,data,para,fencecmd,caption,base,label,fname]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (the_fence === '```' ) {
        ...
        o.push([id,row,row2,brand,0,data,para,fencecmd,caption,base,label,fname]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if (v) {
        ...
        o.push([id,row,row2,'PLST',0,data,para,fencecmd,caption,base,label,fname]);
        caption = ''; label = ''; fencecmd = {};
        continue
      }
      ...
      if (this.re_listblock.test(para[0])) {
        ...
        o.push([id,row,row2,'LIST',0,data,para,fencecmd,caption,base,label,fname]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if ((v = this.re_hdgs.exec(para[0])) !== null) {
        var hdgn = v[1].length + parseInt(plevel);
        var text = v[2];
        var data = [hdgn,text];
      ...
      /// this is the PART block: 
      ///
      /// # Part 1: Background #
      /// ## Part 1: Background ##
      /// ### Part 1: Background ###
      /// #### Part 1: Background ####
      if ((v = this.re_part.exec(para[0])) !== null) {
        var text = v[2];
        o.push([id,row,row2,'PART',0,text,para,fencecmd,caption,base,label,fname]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
      ...
      if ((v = this.re_para.exec(para[0])) !== null) {
        ...
        o.push([id,row,row2,'PARA',0,text,para,fencecmd,caption,base,label,fname]);
        caption = ''; label = ''; fencecmd = {};
        ...
        o.push([id,row,row2,'TEXT',0,text,para,fencecmd,caption,base,label,fname]);
        caption = ''; label = ''; fencecmd = {};
        continue;
      }
    }
    ...
    if (!flags.title) {
      var firstblock = o.shift();
      var title = firstblock[6][0];
      ///if the title starts with a hash, then go ahead and remove it,
      ///and also goto all HDGS blocks in the list and reduce the heading
      ///level by 1. This is to work with a traditional MD file where the
      ///first line starts with a single hash and all subsequent subsections
      ///starts with two hashes. In this way, the first line is treated
      ///as a title and all subsequent sections are reduced the level by 1.
      if (title[0] === '#') {
        title = title.slice(1);
      ...
      flags.title = title;
      var data = [plevel,title];
      firstblock[5] = data;
      firstblock[3] = 'HDGS';
      o.unshift(firstblock);
    }
