...
///console.log(`image ${fsrc} changed`);
  ...
  async saveAs (savefilepath) {
    ...
    try {
      ...
      if (this.saveastype === 'xelatex') {

        const translator = new NitrilePreviewXelatex(this.parser);
        translator.translate_blocks();
        var data = translator.to_xelatex_document();
      ...
      else if (this.saveastype === 'lualatex') {
      ...
      else if (this.saveastype === 'pdflatex') {

        const translator = new NitrilePreviewPdflatex(this.parser);
        translator.translate_blocks();
