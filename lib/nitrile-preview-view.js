    ...
    this.disposables.add(
      atom.workspace.getCenter().observeActivePaneItem( (item) => {
        if (atom.workspace.isTextEditor(item)) {
          this.new_editor = item;
console.log('observe new editor');
          if (!this.editor) {
console.log('switch to new editor');
            this.editor = this.new_editor;
            this.setupEditor();
            this.updateBlocks();
    ...
    this.subscriptions.add(
      editor.onDidDestroy(() => {
        if (editor === this.editor) {
          ...
          /// a new source editor
console.log('editor is destroyed, setting this.editor pointer to null.');
          this.editor = null;
          this.setupEditor();
          this.updateBlocks();
        }
...
console.log('calling getSubFlow');
...
console.log('updateBlocks has returned');
  ...
  jumpToEditor (event) {
    ...
    if (!this.editor ) {
console.log('this.editor pointer is null, going to try to open the path');
