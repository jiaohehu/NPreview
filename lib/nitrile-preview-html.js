    ...
    for (var block of blocks) {
      ...
      switch (type) {
        ...
        case 'VRSE': {
          ...
          o.push(`<div id='${id}' class='${type}' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='margin-left:${left}'>`);
          o.push(`<blockquote>`);
        ...
        case 'VERB': {
          ...
          var text = data;
          if (fencecmd['frame']) {
            o.push(`<div id='${id}' class='${type}' section='${section}' fName='${fname}' rows='${row1} ${row2}' style='border:1px solid;margin-left:${left}'>`);
            var text = text.join('\n');
        ...
        case 'SPEC': {
          ...
          for (var i=0; i < text.length; i+=2) {
            ...
            if (i == 0) {
              o.push(`<tr><th>${dt}</th><th>${dd}</th></tr>`);
            } else {
              o.push(`<tr><td>${dt}</td><td>${dd}</td></tr>`);
            }
          }
          o.push(`</tbody>`);
          o.push(`</table>`);
        ...
        case 'DESC': {
          ...
          o.push(`<div id='${id}' class='${type}' section='${section}' fName='${fname}' rows='${row1} ${row2}'>`);
          o.push('<dl>');
