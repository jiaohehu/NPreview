...
class NitrilePreviewDiagram extends NitrilePreviewBase {
    ...
    switch (fun_str) {
      ...
      case 'midpoint':
        ...
        if (args.length == 2) {
          ...
          if (coords && coords.length >= 2 && Number.isFinite(fraction)) {
          ...
          if (coords0 && coords0.length >= 1 &&
              coords1 && coords1.length >= 1 && Number.isFinite(fraction)) {
            var z0 = this.point(coords0, 0);
            var z1 = this.point(coords1, 0);
            var z0x = parseFloat(z0[0]);
            var z0y = parseFloat(z0[1]);
            var z1x = parseFloat(z1[0]);
            var z1y = parseFloat(z1[1]);
  ...
  point(coords, i) {
    /// * NOTE: This method is to return a point from a 
    ///   coords array
    ///
