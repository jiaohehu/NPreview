...
///~~~
  ...
  to_math_svg(line,isdisplaymath,cssfontrate){
    ...
    opt += ` style='vertical-align:baseline;`
    opt += ` outline:0px solid orange'`
  ...
  make_line(maths,label,idnum){
    ...
    var {s,w,h,shiftdist} = this.to_math_svg(line);
...
//console.log('shiftdist=',shiftdist);
        ...
        let math_style = `left:${dist}pt;position:relative;text-align:left;`;
