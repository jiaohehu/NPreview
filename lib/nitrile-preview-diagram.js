...
//console.log('parseLine',line,p);
 ...
 console.log('saveas symbol=',symbol,'this.lastp.coords=',this.lastp.coords);
  ...
  fixRef (t) {
console.log('fixRef: t=',t);
    if (this.re_func.test(t)) {
      var v = this.re_func.exec(t);
      var coords = this.execFunc(v[1],v[2]);
console.log('fixRef coords=',coords);
      if (coords.length) {
console.log('fixRef returns=',coords[0]);
        t = coords[0];
      } else {
console.log('fixRef returns=[0,0]');
        t = [0,0];
      }
    }
...
console.log('execFunc fun_str=',fun_str);
console.log('execFunc arg_str=',arg_str);
    var ret_val = [];
    switch (fun_str) {
      case 'midpoint':
...
console.log('execFunc ret_val=',ret_val);
            return ret_val;
          }
        }
        break;
