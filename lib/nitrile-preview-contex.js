  ...
  do_hdgs(block){
    ...
    if (!this.haschapter) {
      switch (level) {
        ...
        case 1:
          o.push(`\\startsection[title={${dept}~~${text}},reference={${this.xbaselabel}},bookmark=${raw}]`);
          o.push('');
          break;
        case 2:
          o.push(`\\startsubsection[title={${dept}~~${text}},reference={${this.xbaselabel}},bookmark=${raw}]`);
          o.push('');
          break;
        case 3:
          o.push(`\\startsubsubsection[title={${dept}~~${text}},reference={${this.xbaselabel}},bookmark=${raw}]`);
          o.push('');
          break;
        default:
          o.push(`\\startsubsubsubject[title={${dept}~~${text}},reference={${this.xbaselabel}},bookmark=${raw}]`);
          o.push('');
          break;
      }
    } else {
      switch (level) {
        case 0:
          break;///this needs to be ignore specifically otherwise it
                ///will show through 'default'
        case 1:
          o.push(`\\startchapter[title={${dept}~~${text}},reference={${this.xbaselabel}},bookmark=${raw}]`);
          o.push('');
          break;
        case 2:
          o.push(`\\startsection[title={${dept}~~${text}},reference={${this.xbaselabel}},bookmark=${raw}]`);
