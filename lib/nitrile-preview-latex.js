    ...
    for (var block of all) {
      ...
      switch (sig) {
        ...
        case 'TBLR': {
          ...
          o.push(this.toSingleLineRows(hlines,vpadding,rows));
        ...
        case 'equation': {
          ...
          o.push(`\\begin{equation${star}}${label_cmd}`);
          o.push(`\\begin{split}`);
          o.push(ss.join('\\\\\n'));
          o.push(`\\end{split}`);
        ...
        case 'LSTG': {
          ...
          myopts.push(`basicstyle=\\ttfamily${this.xsize}`);
          ...
          myopts.push(`xleftmargin=${this.xnumbersep}`);
          if (caption_text) {
