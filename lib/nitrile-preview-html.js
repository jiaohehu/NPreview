  ...
  do_verb(block) {
    ...
    if (this.xnumbers) {
      ...
      for (var k=0; k < text.length; ++k) {
        ...
        s.push(`<tr><td style='font-size:xx-small;padding-right:${this.xnumbersep};'>${++linenum}</td><td style='white-space:pre;width:100%;font-size:${this.xcssfontsize};'><code>${line}</code></td></tr>` );
        while (lines.length > 0) {
          var line = lines.shift();
          line = this.escape(line);
          s.push(`<tr><td></td><td style='white-space:pre;width:100%;font-size:${this.xcssfontsize};'><code>${line}</code></td></tr>` );
        }
      }
    } else {
      for (var k=0; k < text.length; ++k) {
        ...
        var line = lines.shift();
        line = this.escape(line);
        s.push(`<tr><td style='white-space:pre;width:100%;font-size:${this.xcssfontsize};'><code>${line}</code></td></tr>` );
        while (lines.length > 0) {
          var line = lines.shift();
          line = this.escape(line);
          s.push(`<tr><td style='white-space:pre;width:100%;font-size:${this.xcssfontsize};'><code>${line}</code></td></tr>` );
