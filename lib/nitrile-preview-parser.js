...
class NitrilePreviewParser {
  ...
  toBlocks(lines,fname,subrow,plevel,o) {
    ...
    while (lines.length > 0) {
        ...
        if (!isNaN(m) && m > 0) {
          ...
          if (v) {
            if (v[1].length >= m) {
              ...
              var fencecmd = {};
              o.push([id,row,row2,'SMPL',0,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
              continue;
            }
          }
        }
      ...
      if (the_fence === '```') {
        ...
        if (fencecmd.listing) {
          o.push([id,row,row2,'LSTG',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        } else {
          o.push([id,row,row2,'CODE',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        }
        continue;
      }
      ...
      if (the_fence === '~~~') {
        var [data, n] = this.trimPara(para);
        var [data,fence,fencecmd] = this.trimFences(data);
        o.push([id,row,row2,'VERB',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (the_fence === '---') {
        ...
        o.push([id,row,row2,'VRSE',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue
      }
      ...
      if (the_fence === '///') {
        ...
        if (fencecmd.figure) {
          o.push([id,row,row2,'FIGE',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        } else {
          o.push([id,row,row2,'PICT',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        }
        continue;
      }
      ...
      if (the_fence === '===') {
        ...
        o.push([id,row,row2,'TABB',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (the_fence === '<<<') {
        ...
        o.push([id,row,row2,'TERM',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (the_fence === '\"\"\"') {
        ...
        o.push([id,row,row2,'QUOT',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (the_fence === '\$\$\$') {
        ...
        o.push([id,row,row2,'EQTN',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (this.re_hyphen_hyphen.test(para[0])) {
        ...
        var fencecmd = {};
        o.push([id,row,row2,'DESC',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        var fencecmd = {};
        o.push([id,row,row2,'PRIM',0,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var data = [lead,text];
        var fencecmd = {};
        o.push([id,row,row2,'SECO',0,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (v) {
        ...
        var fencecmd = {};
        o.push([id,row,row2,'PLST',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue
      }
      ...
      if ((v = this.re_hdgs.exec(para[0])) !== null) {
        ...
        var fencecmd = {};
        o.push([sid,row,row2,'HDGS',0,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (nblocks == 1) {
        ...
        var fencecmd = {};
        o.push([id,row,row2,'HDGS',0,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
      ...
      if (true) {
        ...
        var data = this.joinPara(data);
        var fencecmd = {};
        o.push([id,row,row2,'',n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel]);
        continue;
      }
  ...
  newPART (subrow,subpart) {
    ...
    var fname = '';
    var plevel = 0;
    return [id,-1,-1,'PART',0,subpart,[],fencecmd,dept,fig,caption,base,fname,subrow,plevel];
  ...
  newFILE (fname,subrow,plevel) {
    ...
    var base = '';
    return [id,-1,-1,'FILE',0,[],[],fencecmd,dept,fig,caption,base,fname,subrow,plevel];
  ...
  newFEND (fname,subrow,plevel) {
    ...
    var id = `${this.toBase(fname)}::`;
    var base = '';
    return [id,-1,-1,'FEND',0,[],[],fencecmd,dept,fig,caption,base,fname,subrow,plevel];
  ...
  newHDGS (str,fname,subrow,plevel) {
    ...
    var fig = '';
    var base = '';
    return ['',-1,-1,'HDGS',0,[0,str],[],fencecmd,dept,fig,caption,base,fname,subrow,plevel];
  ...
  idenXrefs (config,blocks,isarticle) {
    ...
    for (var block of blocks) {
      const [id,row1,row2,sig,n,data,para,fencecmd,dept,fig,caption,base,fname,subrow,plevel] = block;
      if (fencecmd.label) {
        if (sig === 'HDGS') {
          if (xrefs[fencecmd.label]) xrefs[id].push( `${dept}` );
          else xrefs[fencecmd.label] = [dept];
        } else if (fig ) {
          if (xrefs[fencecmd.label]) xrefs[id].push( `${fig}` );
          else xrefs[fencecmd.label] = [fig];
        }
      }
    }
    return xrefs;
