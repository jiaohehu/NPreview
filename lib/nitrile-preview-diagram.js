...
class NitrilePreviewDiagram {
  ...
  parseLine(line) {
    ...
    if ((v = this.re_set_command.exec(line)) !== null) {
      ...
      else if (key === 'refsx')     { this.refsx     = this.assertFloat(val, this.def_refsx, this.MIN, this.MAX); } ///such as 1
      else if (key === 'refsy')     { this.refsy     = this.assertFloat(val, this.def_refsy, this.MIN, this.MAX); } ///such as 1
