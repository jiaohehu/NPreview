  ...
  toInnerSvg (v, compact=false) {
    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
        ...
        case '\\sqrt':
          ...
          if(1){
            ...
            o.push(`<line x1='${lead}pt' y1='0.5pt' x2='${w}pt' y2='0.5pt' style='stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
            this.used.add(`${idr_}`);
            if(n){
      ...
      if (id === 'myINT') { 
        ...
        //FUN
        //An unrecoginized function such as \Rot, treate it as 
        /// a new function
        var v = v.slice(1);
