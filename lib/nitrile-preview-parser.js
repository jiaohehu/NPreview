...
class NitrilePreviewParser {
  ...
  newConfig() {
    ...
    config.QUOT.right='5';///0mm margin
    config.QUOT.cssfontsize = '1em';
    config.QUOT.latfontsize = '\\normalsize';
    config.QUOT.confontsize = '\\tf';
    config.FRMD = {};
    ...
    while (lines.length > 0) {
      ...
      if (block_type === 'SAMP') {
        ...
        if (block_type0 === 'SAMP') {
          var bl = o.pop();
          var data = bl.data;
          var mydata = this.trimSampPara(para); /// m is to be ignored
